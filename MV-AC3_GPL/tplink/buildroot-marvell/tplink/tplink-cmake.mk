...
define tplink-inner-cmake-package
...
# make targets
$(call tplink-inner-generic-package,$(1),$(2),$(3),$(4))
...
tplink-cmake-package = $(call tplink-inner-cmake-package,$(pkgname),$(call UPPERCASE,$(pkgname)),$(call UPPERCASE,$(pkgname)),target)
host-cmake-package = $(call tplink-inner-cmake-package,host-$(pkgname),$(call UPPERCASE,host-$(pkgname)),$(call UPPERCASE,$(pkgname)),host)
...
$(HOST_DIR)/usr/share/buildroot/tp-toolchainfile.cmake:
	@mkdir -p $(@D)
	sed \
