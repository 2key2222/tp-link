...
void misc_init_r_env(void){
	...
	envSetDefault("baudrate", tmp_buf);
#endif
	...
	sprintf(tmp_buf,"nand0=armada-nand,spi%d=spi_flash",ENV_SPI_MAIN_CHANNEL);
	envSetDefault("mtdids", tmp_buf);
