...
#define TP_SWITCH_PWD_RECOVERY        "PWD_RECOVERY"         /* 密码恢复开关 */
#define TP_SWITCH_PWD_RECOVERY_FLAG   "PWD_RECOVERY_FLAG"    /* 密码恢复标志 */
#define TP_SWITCH_RESET_DISABLE						"RESET_DISABLE"
