...
sub HELP_MESSAGE
{
	...
	print "\n";
	print "Options:\n";
	print "\t-n\tSwitch name.Tplink custom switch name: TL_SG2210HP_M2";
...
getopt('f:b:o:i:v:d:m:r:u:g:z:a:k:j:x:l:n');
...
{
	system("echo \"#define $opt_n \" >> include/config.h");
	print "TPLINK custom switch name is $opt_n \n"
}
