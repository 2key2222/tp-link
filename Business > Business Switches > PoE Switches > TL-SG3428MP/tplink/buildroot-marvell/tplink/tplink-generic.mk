...
$(BUILD_TPLINK_DIR)/%/.stamp_downloaded:
...
# Unpack the archive
$(BUILD_TPLINK_DIR)/%/.stamp_extracted:
...
# used.
$(BUILD_TPLINK_DIR)/%/.stamp_rsynced:
...
$(BUILD_TPLINK_DIR)/%/.stamp_patched: NAMEVER = $(RAWNAME)-$($(PKG)_VERSION)
$(BUILD_TPLINK_DIR)/%/.stamp_patched: PATCH_BASE_DIRS =  $(PKGDIR)
$(BUILD_TPLINK_DIR)/%/.stamp_patched: PATCH_BASE_DIRS += $(addsuffix /$(RAWNAME),$(call qstrip,$(BR2_GLOBAL_PATCH_DIR)))
$(BUILD_TPLINK_DIR)/%/.stamp_patched:
...
# Configure
$(BUILD_TPLINK_DIR)/%/.stamp_configured:
...
# Install to host dir
$(BUILD_TPLINK_DIR)/%/.stamp_host_installed:
...
#
$(BUILD_TPLINK_DIR)/%/.stamp_staging_installed:
...
$(BUILD_TPLINK_DIR)/%/.stamp_images_installed:
...
$(BUILD_TPLINK_DIR)/%/.stamp_target_installed:
...
$(BUILD_TPLINK_DIR)/%/.stamp_dircleaned:
	rm -Rf $(@D)
...
define tplink-inner-generic-package
...
$(2)_DIR	=  $$(BUILD_TPLINK_DIR)/$$($(2)_BASE_NAME)
...
endef # tplink-inner-generic-package
...
tplink-generic-package = $(call tplink-inner-generic-package,$(pkgname),$(call UPPERCASE,$(pkgname)),$(call UPPERCASE,$(pkgname)),target)
# In the case of host packages, turn the package name "pkg" into "host-pkg"
host-generic-package = $(call tplink-inner-generic-package,host-$(pkgname),$(call UPPERCASE,host-$(pkgname)),$(call UPPERCASE,$(pkgname)),host)
