...
/*TPLINK_CUSTOM: for uboot tplink menu funcs*/
/*UBOOT init debug print msg*/
//#define MV_RT_DEBUG
#define TPLINK_CUSTOM

#if defined(TL_SG2210HP_M2)
#define CONFIG_PHY_AQR412C
#define CONFIG_SM_XSMI

#define TPLINK_USB_CONSOLE_EN_PIN       27
#define TPLINK_USB_CONSOLE_INSERT_PIN   8 

#define TPLINK_USB_CONSOLE

#elif defined(T2700G_28TQ_V3) || defined(OSW_24G_400W)
#define CONFIG_PHY_1680

#define TPLINK_USB_CONSOLE_EN_PIN       5
#define TPLINK_USB_CONSOLE_INSERT_PIN   11 
 ...
 */
#define CONFIG_BAUDRATE         	38400   /* console baudrate = 115200    */
...
#ifdef TPLINK_CUSTOM
#define CONFIG_ENV_OFFSET_SPI		0xE0000
#define SPI_FLASH_BYTE_MODE 3
#else
#define CONFIG_ENV_OFFSET_SPI		0x100000			/* (1MB For Image) environment starts here  */
#endif
#define CONFIG_ENV_SPARE_BLOCK		4 /* 	A multiple of the NAND device's block size.	*
...
#define CONFIG_ENV_SIZE_NAND		0x80000		/* environment takes one erase block */
#define CONFIG_ENV_OFFSET_NAND		nand_get_env_offs() /* environment starts here  */
