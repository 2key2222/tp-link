...
#define DBG(arg...) do{if(gev_debug){printf("%s,%d:",__FUNCTION__, __LINE__);printf(arg);}}while(0)
...
char* getDftGevContent(int *otGevSize)
{
    ...
    *otGevSize = gevSize;
    ...
    strncpy(value+ENV_ITEM_VALUE_OFFSET(9), "0xa00000", ENV_ITEM_VALUE_LEN);
    pbm[10]=0x1;
    strncpy(value+ENV_ITEM_NAME_OFFSET(10), TP_SWITCH_FL_OFFSET_USRIMG2, ENV_ITEM_NAME_LEN);
    strncpy(value+ENV_ITEM_VALUE_OFFSET(10), "0x1100000", ENV_ITEM_VALUE_LEN);
    pbm[11]=0x1;
    strncpy(value+ENV_ITEM_NAME_OFFSET(11), TP_SWITCH_FL_SIZE_USRIMG2, ENV_ITEM_NAME_LEN);
    strncpy(value+ENV_ITEM_VALUE_OFFSET(11), "0xa00000", ENV_ITEM_VALUE_LEN);
    pbm[12]=0x1;
    strncpy(value+ENV_ITEM_NAME_OFFSET(12), TP_SWITCH_FL_OFFSET_USRAPP, ENV_ITEM_NAME_LEN);
    strncpy(value+ENV_ITEM_VALUE_OFFSET(12), "0x1b00000", ENV_ITEM_VALUE_LEN);
    pbm[13]=0x1;
    strncpy(value+ENV_ITEM_NAME_OFFSET(13), TP_SWITCH_FL_SIZE_USRAPP, ENV_ITEM_NAME_LEN);
    strncpy(value+ENV_ITEM_VALUE_OFFSET(13), "0x400000", ENV_ITEM_VALUE_LEN);
    pbm[14]=0x1;
