...
enum attr_move_type {MOVE_TYPE_UNKNOWN, MOVE_TYPE_LOAD, MOVE_TYPE_FPLOAD, MOVE_TYPE_STORE, MOVE_TYPE_FPSTORE, MOVE_TYPE_MTC, MOVE_TYPE_MFC, MOVE_TYPE_MTHILO, MOVE_TYPE_MFHILO, MOVE_TYPE_MOVE, MOVE_TYPE_FMOVE, MOVE_TYPE_CONST, MOVE_TYPE_CONSTN, MOVE_TYPE_SIGNEXT, MOVE_TYPE_EXT_INS, MOVE_TYPE_LOGICAL, MOVE_TYPE_ARITH, MOVE_TYPE_SLL0, MOVE_TYPE_ANDI, MOVE_TYPE_LOADPOOL, MOVE_TYPE_SHIFT_SHIFT, MOVE_TYPE_LUI_MOVF};
extern enum attr_move_type get_attr_move_type (rtx);

#define HAVE_ATTR_alu_type
...
#define HAVE_ATTR_sync_inclusive_mask
...
#define HAVE_ATTR_sync_exclusive_mask
...
#define HAVE_ATTR_sync_required_oldval
...
#define HAVE_ATTR_sync_insn1_op2
