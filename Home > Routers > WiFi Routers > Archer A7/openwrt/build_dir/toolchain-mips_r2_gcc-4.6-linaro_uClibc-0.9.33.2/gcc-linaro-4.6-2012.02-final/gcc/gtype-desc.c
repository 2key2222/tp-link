...
{
  struct target_libfuncs * const x = (struct target_libfuncs *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_15target_libfuncs, gt_ggc_e_15target_libfuncs))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(LTI_MAX);
...
{
  struct target_rtl * const x = (struct target_rtl *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_10target_rtl, gt_ggc_e_10target_rtl))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(GR_MAX);
...
{
  struct target_globals * const x = (struct target_globals *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_14target_globals, gt_ggc_e_14target_globals))
    {
...
gt_pch_p_15target_libfuncs (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct target_libfuncs * const x ATTRIBUTE_UNUSED = (struct target_libfuncs *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(LTI_MAX);
    for (i0 = 0; i0 != l0; i0++) {
...
gt_pch_p_10target_rtl (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct target_rtl * const x ATTRIBUTE_UNUSED = (struct target_rtl *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(GR_MAX);
    for (i0 = 0; i0 != l0; i0++) {
...
gt_pch_p_14target_globals (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct target_globals * const x ATTRIBUTE_UNUSED = (struct target_globals *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).rtl), cookie);
  if ((void *)(x) == this_obj)
...
void * ggc_alloc_splay_tree_interface_tuple_htab (int sz, void * nl)
{
  return ggc_splay_alloc (gt_e_P15interface_tuple4htab, sz, nl);
}
...
{
  return ggc_splay_alloc (gt_e_P18mips16_local_alias4htab, sz, nl);
}

void * ggc_alloc_splay_tree_mflip_mips16_entry_htab (int sz, void * nl)
{
  return ggc_splay_alloc (gt_e_P18mflip_mips16_entry4htab, sz, nl);
}
