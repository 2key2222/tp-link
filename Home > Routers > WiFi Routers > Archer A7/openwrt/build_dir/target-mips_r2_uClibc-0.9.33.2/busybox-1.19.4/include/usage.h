...
#define ipcalc_tp_trivial_usage \
       "ADDRESS NETMASK START_IP COUNT" \

#define ipcalc_tp_full_usage "\n\n" \
       "TP-LINK uses to Calculate IP network settings from a IP address for DHCP Server\n" \
...
#define mac_addr_trivial_usage \
       "COMMAND [MODE] [MAC ADDRESS]" \

#define mac_addr_full_usage "\n\n" \
       "Increase or decrease mac address\n" \
     "\n	mode		1 - increase" \
     "\n			2 - decrease" \
