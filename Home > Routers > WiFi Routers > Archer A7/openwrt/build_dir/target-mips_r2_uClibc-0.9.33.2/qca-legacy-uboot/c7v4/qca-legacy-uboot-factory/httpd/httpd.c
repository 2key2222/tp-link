...
void httpd_appcall(void){
	...
	unsigned int i;
	//printf("enter httpd_appcall state %d count %d pointer 0x%08x uip_flags %d\n", 
	//	hs->state, hs->count, (int)webfailsafe_data_pointer, uip_flags);
...
//mod by zw below 20160219
				...
				printf("Request for: %-20.19s\n", &uip_appdata[4]);
				//printf("strlen of request = %d\n",strlen(&uip_appdata[4]));
