 ...
 *
 * $Revision: 65683 $
 * $Date: 2016-01-29 11:28:59 +0800 (週五, 29 一月 2016) $
 *
...
rtk_api_ret_t rtk_led_OutputEnable_set(rtk_enable_t state)
{
    ...
    if ((retVal = rtl8367c_setAsicLedOutputEnable_set(state))!=RT_ERR_OK)
        return retVal;
...
rtk_api_ret_t rtk_led_OutputEnable_get(rtk_enable_t *pState)
{
    ...
    if ((retVal = rtl8367c_getAsicLedOutputEnable_get(pState))!=RT_ERR_OK)
        return retVal;
