...
Currently available applets include:
	...
	chmod, chown, chroot, chrt, clear, cmp, cp, crond, crontab, cut,
	date, dd, devmem, df, dhcprelay, diff, dirname, dmesg, du,
	dumpleases, echo, egrep, env, expr, false, fgrep, find, free, fsync,
	grep, gunzip, gzip, halt, head, hexdump, hostid, hwclock, id,
	ifconfig, kill, killall, less, ln, logger, login, ls, lsof, md5sum,
	mdev, mkdir, mkfifo, mknod, mkswap, mktemp, mount, mv, nc, netstat,
	nice, nslookup, ntpd, passwd, pgrep, pidof, ping, ping6, pivot_root,
	poweroff, printf, ps, pwd, readlink, reboot, reset, rm, rmdir,
	route, sed, seq, sh, sha1sum, sleep, sort, start-stop-daemon, stat,
	strings, switch_root, sync, sysctl, tail, tar, taskset, tee, telnet,
	telnetd, test, tftp, tftpd, time, top, touch, tr, traceroute, true,
	udhcpc, udhcpd, umount, uname, uniq, unzip, uptime, usleep, vconfig,
