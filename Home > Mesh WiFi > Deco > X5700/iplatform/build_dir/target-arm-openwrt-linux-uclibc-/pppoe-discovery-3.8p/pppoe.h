...
typedef struct PPPoEConnectionStruct {
	...
	int padoSocket;         /* Raw socket for receiving PADO packets */
	...
	int bindDevice;			/* if bind socket with interface */
} PPPoEConnection;
...
int openInterface(char const *ifname, UINT16_t type, unsigned char *hwaddr, int bindDevice);
