...
--- Apply or remove an advisory lock on the file.
-- @class function
-- @name File.flock
-- @usage This function calls flock() on POSIX.
-- @usage The "sh" command places a shared lock, "ex" places an exclusive lock,
-- "un" unlocks.
-- @param command	Locking Command ["sh", "ex", "un"]
-- @param noblock	Make a nonblocking request. (optional)
-- @return true
