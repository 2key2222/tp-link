...
ifeq ($(DUMP),1)
  ...
  ifneq (,$(findstring uml,$(BOARD)))
    ...
    # to configure KERNEL_CC/CROSS accoring to CONFIG_LINUX_KARCH(arm/arm64), instead of BOARD
    ifneq (,$(findstring 64,$(CONFIG_LINUX_KARCH)))
...
#  KERNEL_BUILD_DIR ?=$(BUILD_DIR_BASE)/linux-$(LINUX_VERSION)
	KERNEL_BUILD_DIR :=$(BUILD_DIR_BASE)/linux-$(BOARD)-$(PRODUCT)
...
#  endif
  ...
  ifeq ($(strip $(CONFIG_LINUX_KERNEL_VERSION)),"")
    ...
    LINUX_UNAME_VERSION:=$(CONFIG_LINUX_KERNEL_VERSION)
  endif

  # platform kernel modules install lib/modules/$(LINUX_UNAME_VERSION)
  # so sbin/kmodloader can find xxx.ko correctly
