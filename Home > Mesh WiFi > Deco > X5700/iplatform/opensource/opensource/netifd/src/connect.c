...
static int connect_ipt_outgone(void);
...
static time_t last_in_sec;
static time_t last_ex_sec;
...
connect_ipt_outgone(void)
{
    ...
    memcpy(&last_stat, &ipts, sizeof(ipts));
