...
#if defined(CONFIG_BCM963138) || defined(CONFIG_BCM963148) || defined(CONFIG_BCM963381) || defined(CONFIG_BCM_PON) || defined(CONFIG_BCM94908) || \
    defined(CONFIG_BCM963158) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM947622) || defined(CONFIG_BCM96878) /* IMPL1 */
...
#define   PCM_NCO_SOFT_INIT      0x00000080
    ...
    uint32        dpll_control;                // Configs dpll control settings ( New in 63381 )
...
#define   DPLL_PHS_THSHLD_SHIFT           4
    uint32        dpll_nom_freq;               // Configs FCW for nominal frequency ( New in 63138 )
    uint32        dpll_div;                    // Configs reference and local clock divider ( New in 63138 )
#define   DPLL_REF_DIV_SHIFT             16

    uint32        dpll_acq_freq;               // Provides FCW for local oscillator
    uint32        dpll_status;                 // Provides DPLL status
#define   DPLL_IN_SYNC           0x80000000
#define   DPLL_ACQ_FREQ_VALID    0x40000000
#define   DPLL_K0_SHIFT                   8

#if defined(CONFIG_BCM96858) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96856) || defined(CONFIG_BCM963178) || defined(CONFIG_BCM947622) || defined(CONFIG_BCM96878)
...
#define PCM ((volatile struct pcm_ctrl_regs * const) PCM_BASE)
