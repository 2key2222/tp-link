...
#ifdef HOSTAPD_IGNORE_SIGINT_SIGTERM
	if(0 == access("/tmp/system_rebooting", 0))
	{
		wpa_printf(MSG_ERROR, "Signal %d received - nothing to do when rebooting", sig);
		return;
	}
#endif /* HOSTAPD_IGNORE_SIGINT_SIGTERM */
#endif /* SUPPORT_TP_DECO */
