...
/*
*	Hanjiayan@20190228 modified, 
*	MLD messages will set igmp flag, when mrouters_only flag is set also, the package will not send out
*/
...
// 合并路由的代码，打开了multicast_querier，但是，这会导致打开vlan之后，lan侧客户端无法正常播放wan端的组播视频。
//	当前Deco平台默认关闭这个开关，跟平台同步，也解决了vlan播放组播的问题。	 -- by liujianan 2020.8.12
