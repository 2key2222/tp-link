...
#define GFAST_START_TPS_TESTMODE 0x4
...
/* VDSL2-LR modes */
#define		kVdslLROff				0
#define		kVdslLRShortLoop		1
#define		kVdslLRMediumLoop		2
#define		kVdslLRLongLoop			3
...
#define		kVdslSOSEnableAux	0x08000000
#define		kVdslROCEnableAux	0x10000000
...
#define kOidAdslPrivGetGfastDta        51
...
#define GFAST_SUPPORTEDOPTIONS_ANDEFTR   (0x04 << 8)
...
typedef struct _xdslGinpExtRateStat {
    unsigned int    maxEFTRds;
    unsigned int    maxEFTRus;
} xdslGinpExtRateStat;
...
#else
#define US_DIRECTION  TX_DIRECTION
#define DS_DIRECTION  RX_DIRECTION
#endif
...
typedef struct _adslMibInfo {
	...
	xdslGinpExtRateStat ginpExtRateStat;
