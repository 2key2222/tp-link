...
#if defined(CONFIG_BCM_OVS) && defined(CONFIG_BLOG)
	if (blog_match)
		*blog_match = ovs_bcm_blog_match_validate(match, key_attrs, mask_attrs);
#endif
				       ...
				       int attr_len, bool log)
{
    ...
    // fix flow actions reallocation bug in OVS2.8.x. see https://patchwork.ozlabs.org/patch/1067833/
