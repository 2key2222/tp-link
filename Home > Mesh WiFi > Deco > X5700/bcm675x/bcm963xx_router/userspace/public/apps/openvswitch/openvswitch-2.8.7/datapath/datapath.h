...
/**
 * Broadcom specific pkt info that is needed to be passed from 
 * ovs datapath to userspace for pkt handling. 
 */
	struct ovs_bcm_pktmetadata {
		u32 to_acceldev_ifi;
	};
#endif
...
struct dp_upcall_info {
	...
	u16 mru;
#if defined(CONFIG_BCM_OVS_MCAST)
	struct ovs_bcm_pktmetadata bcm_pktmetadata;
#endif
};
