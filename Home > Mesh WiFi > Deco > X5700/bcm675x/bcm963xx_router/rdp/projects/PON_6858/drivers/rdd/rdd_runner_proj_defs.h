...
/* CPU RX */
#define CPU_RX_THREAD_NUMBER                 IMAGE_1_CPU_IF_1_CPU_RX_THREAD_NUMBER
#define CPU_RX_COPY_THREAD_NUMBER            IMAGE_1_CPU_IF_1_CPU_RX_COPY_THREAD_NUMBER
#define PKTGEN_TX_THREAD_NUMBER              IMAGE_1_CPU_IF_1_CPU_RX_COPY_THREAD_NUMBER
#define CPU_RX_METER_BUDGET_ALLOCATOR_TASK   IMAGE_1_CPU_IF_1_CPU_RX_METER_BUDGET_ALLOCATOR_THREAD_NUMBER
