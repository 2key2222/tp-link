...
{
    RDD_BYTES_2_BITS_WRITE_G(bits, RDD_US_TM_WAN_1_BB_DESTINATION_TABLE_ADDRESS_ARR, 0);
...
{
    RDD_BYTES_2_BITS_READ_G(*bits, RDD_US_TM_WAN_1_BB_DESTINATION_TABLE_ADDRESS_ARR, 0);
...
{
    RDD_BYTES_2_BITS_WRITE_G(bits, RDD_BBH_TX_US_WAN_1_FIFO_BYTES_THRESHOLD_ADDRESS_ARR, 0);
...
{
    RDD_BYTES_2_BITS_READ_G(*bits, RDD_BBH_TX_US_WAN_1_FIFO_BYTES_THRESHOLD_ADDRESS_ARR, 0);
...
{
    RDD_BYTE_1_BITS_WRITE_G(bits, RDD_WAN_1_BBH_TX_FIFO_SIZE_ADDRESS_ARR, 0);
...
{
    RDD_BYTE_1_BITS_READ_G(*bits, RDD_WAN_1_BBH_TX_FIFO_SIZE_ADDRESS_ARR, 0);
