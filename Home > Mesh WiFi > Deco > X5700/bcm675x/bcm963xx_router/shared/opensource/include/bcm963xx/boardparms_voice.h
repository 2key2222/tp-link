...
#define VOICECFG_DECO_VOICE_X20_V1_STR       "Voice_X20_V1"
...
#define BP_MAX_CHANNELS_PER_DEVICE     4
...
#define BP_PCM_TS_COUNT(compression, rate)  \
   ((compression == BP_VC_COMP_LINEAR) ? 2 : 1)
...
{                                \
   ...
   {                             \
      BP_CHAN( BP_VC_INACTIVE, BP_VCTYPE_NONE, BP_VC_COMP_LINEAR, BP_VC_16KHZ ), \
      BP_CHAN( BP_VC_INACTIVE, BP_VCTYPE_NONE, BP_VC_COMP_LINEAR, BP_VC_16KHZ ), \
      BP_CHAN( BP_VC_INACTIVE, BP_VCTYPE_NONE, BP_VC_COMP_LINEAR, BP_VC_16KHZ ), \
      BP_CHAN( BP_VC_INACTIVE, BP_VCTYPE_NONE, BP_VC_COMP_LINEAR, BP_VC_16KHZ ), \
   }                             \
