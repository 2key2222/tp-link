...
VOICE_DAUGHTER_BOARD_PARMS g_voiceBoard_Deco_Voice_X20_V1 =
{
   VOICECFG_DECO_VOICE_X20_V1_STR,   /* Daughter Board ID */
   {
      {
         /* Device Type */
         BP_VD_DECO_VOICE_X20_V1,
         BP_VDTYPE_PCM,
         BP_SPI_SS_NOT_REQUIRED,
         BP_RESET_NOT_REQUIRED,
         /* Channel description */
         {
            BP_CHAN_PCM( BP_VC_ACTIVE, BP_VCTYPE_AUDIO, BP_VC_COMP_LINEAR, BP_VC_16KHZ, TS(0, 1) ),
            BP_CHAN_PCM( BP_VC_ACTIVE, BP_VCTYPE_AUDIO, BP_VC_COMP_LINEAR, BP_VC_16KHZ, TS(2, 3) ),
            BP_CHAN_PCM( BP_VC_ACTIVE, BP_VCTYPE_AUDIO, BP_VC_COMP_LINEAR, BP_VC_16KHZ, TS(4, 5) ),
            BP_CHAN_PCM( BP_VC_ACTIVE, BP_VCTYPE_AUDIO, BP_VC_COMP_LINEAR, BP_VC_16KHZ, TS(6, 7) ),
         }
      },
...
static bp_elem_t g_voice_bcm963158ref4d[] = {
   {bp_cpBoardId,               .u.cp = "963158REF4D"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1}, 
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_4_AL},
   {bp_usGpioFxsFxoRst2,        .u.us = BP_GPIO_3_AL},
   {bp_usGpioVoipRelayCtrl1,    .u.us = BP_GPIO_13_AH},
   {bp_daughterCardList,        .u.ptr = g_963158_dCardList},
   {bp_last}
};
...
static bp_elem_t g_voice_bcm963178sv[] = {
   ...
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},  
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_32_AL}, 
...
static bp_elem_t g_voice_bcm963178ref1[] = {
   ...
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},  
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_25_AL}, 
   {bp_daughterCardList,        .u.ptr = g_963178_dCardList},
   {bp_last}
};
...
static VOICE_DAUGHTER_BOARD_PARMS * g_Deco_Voice_X20_V1_dCardList[] = {
	&g_voiceBoard_Deco_Voice_X20_V1,
	0
};
...
static bp_elem_t g_voice_bcm96755ref1[] = {
   ...
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},  
   {bp_usFxsFxo2SpiSSNum,       .u.us = SPI_DEV_2},  
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_26_AL}, 
   {bp_daughterCardList,        .u.ptr = g_947622_dCardList},  
   {bp_last}
};

static bp_elem_t g_voice_bcm_Deco_Voice_X20_V1[] = {
   {bp_cpBoardId,               .u.cp = "Voice_X20_V1"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},  
   {bp_usFxsFxo2SpiSSNum,       .u.us = SPI_DEV_2},  
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_26_AL}, 
   {bp_daughterCardList,        .u.ptr = g_Deco_Voice_X20_V1_dCardList},  
   {bp_last}
};
...
static bp_elem_t g_voice_bcm968781xsv[] = {
   ...
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_0},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_6_AL},
