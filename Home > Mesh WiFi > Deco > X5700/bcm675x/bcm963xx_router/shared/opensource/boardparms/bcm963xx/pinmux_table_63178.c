...
bp_pinmux_defs_t g_pinmux_defs_0[] =
{
  ...
  { bp_usGpioLedRed,  	-1, 5, 5 | BP_PINMUX_VAL_4|BP_PINMUX_OPTLED_NUM(4) }, //  SW LED
  { bp_usGpioLedGreen,  -1, 6, 6 | BP_PINMUX_VAL_4|BP_PINMUX_OPTLED_NUM(3) }, //  SW LED
  { bp_usGpioLedBlue,  	-1, 7, 7 | BP_PINMUX_VAL_4|BP_PINMUX_OPTLED_NUM(2) }, //  SW LED
  /* virtual gpio to control mix gpio */
  { bp_usGpioLedColorful,    -1, 8, 8 | BP_PINMUX_VAL_4|BP_PINMUX_OPTLED_NUM(8) }, //  SW LED
#endif
