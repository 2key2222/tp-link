...
*/
static bp_elem_t g_Archer_AX1800_2Ge[] = {
    {bp_cpBoardId,               .u.cp = "ArcherAX18002Ge"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
    {bp_usGpioInitState,         .u.us = BP_GPIO_5_AH},
    {bp_usIntfId,                .u.us = 0},
    {bp_usIntfType,              .u.us = BP_INTF_TYPE_GPHY},
    {bp_usPortNum,               .u.us = 0},
    {bp_usNetLed0,               .u.us = BP_GPIO_0_AL},
...
#if 0
static bp_elem_t g_RE_AX1800_2Ge[] = {
    {bp_cpBoardId,               .u.cp = "RE_AX1800_2Ge"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
...
static bp_elem_t g_Deco_AX1800_2Ge[] = {
    {bp_cpBoardId,               .u.cp = "Deco_AX1800_2Ge"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},

    // GPIO5 is designed for the 53134 switch reset
    {bp_usGpioInitState,         .u.us = BP_GPIO_5_AH},
    ...
    {bp_ulPhyId1,                .u.ul = BP_PHY_ID_NOT_SPECIFIED},
    {bp_ulCrossbar,              .u.ul = BP_CROSSBAR_PORT_BASE+1},
    //{bp_ucPhyAddress,            .u.uc = 0x18},
    {bp_ulCrossbarPhyId,         .u.ul = 0x1 |  PHY_INTEGRATED_VALID | MAC_IF_RGMII_3P3V | PHY_EXTERNAL},

#if defined(CONFIG_TP_IMAGE)

    /* GPIO_09 Reset Button  GPIO_11:LED_RED GPIO_12:LED_GREEN GPIO_22:LED_BLUE */
    /* buttons gpio defines */  
    {bp_usButtonIdx,             .u.us = 0},
    {bp_usButtonExtIntr,         .u.us = BP_EXT_INTR_0|BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE|BP_EXT_INTR_TYPE_IRQ_LOW_LEVEL},
    {bp_usGpio_Intr,             .u.us = BP_GPIO_9_AL},
    {bp_usButtonAction,          .u.us = BP_BTN_ACTION_HOTPLUG_EVENT | BP_BTN_TRIG_PRESS },
    {bp_ulButtonActionParm,      .u.ptr = (void*)"reset pressed" },
    {bp_usButtonAction,          .u.us = BP_BTN_ACTION_HOTPLUG_EVENT | BP_BTN_TRIG_RELEASE | BP_BTN_TRIG_0S},
    {bp_ulButtonActionParm,      .u.ptr = (void*)"reset released" },

    /* led gpio defines */
    {bp_usGpioLedRed,             .u.us = BP_GPIO_11_AL},
    {bp_usGpioLedGreen,           .u.us = BP_GPIO_12_AL},
    {bp_usGpioLedBlue,            .u.us = BP_GPIO_22_AL},
    {bp_usGpioLedColorful,        .u.us = BP_GPIO_8_AL},
#endif

    /* add for firmware recovery */
#if defined(_CFE_) && defined(CONFIG_TP_CFE_RECOVERY)
    {bp_usExtIntrResetToDefault,  .u.us = BP_EXT_INTR_NONE},
    {bp_usGpio_Intr,              .u.us = BP_GPIO_9_AL},      /* reset button */
#endif
...
static bp_elem_t g_Deco_X20_V2[] = {
    {bp_cpBoardId,               .u.cp = "Deco_X20_V2"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},

    // GPIO5 is designed for the 53134 switch reset
    {bp_usGpioInitState,         .u.us = BP_GPIO_7_AH},
    ...
    {bp_ulCrossbar,              .u.ul = BP_CROSSBAR_PORT_BASE+1},
    //{bp_ucPhyAddress,            .u.uc = 0x18},
    {bp_ulCrossbarPhyId,         .u.ul = 0x5 |  PHY_INTEGRATED_VALID | MAC_IF_RGMII_3P3V | PHY_EXTERNAL},
...
static bp_elem_t g_Deco_Voice_X20_V1[] = {
    {bp_cpBoardId,               .u.cp = "Voice_X20_V1"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
    ...
    /* GPIO_09 Reset Button  GPIO_02:LED_RED GPIO_01:LED_GREEN GPIO_00:LED_BLUE */
    /* buttons gpio defines */  
    {bp_usButtonIdx,             .u.us = 0},
    {bp_usButtonExtIntr,         .u.us = BP_EXT_INTR_0|BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE|BP_EXT_INTR_TYPE_IRQ_LOW_LEVEL},
    {bp_usGpio_Intr,             .u.us = BP_GPIO_9_AL},
...
#if defined(CONFIG_TP_MODEL_VOICE_X20V1)
    /* mute buttons gpio defines */  
    {bp_usButtonIdx,             .u.us = 1},
    {bp_usButtonExtIntr,         .u.us = BP_EXT_INTR_1|BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE|BP_EXT_INTR_TYPE_IRQ_LOW_LEVEL},
    {bp_usGpio_Intr,             .u.us = BP_GPIO_8_AL},
    {bp_usButtonAction,          .u.us = BP_BTN_ACTION_HOTPLUG_EVENT | BP_BTN_TRIG_PRESS },
    {bp_ulButtonActionParm,      .u.ptr = (void*)"mute pressed" },
    {bp_usButtonAction,          .u.us = BP_BTN_ACTION_HOTPLUG_EVENT | BP_BTN_TRIG_RELEASE | BP_BTN_TRIG_0S},
    {bp_ulButtonActionParm,      .u.ptr = (void*)"mute released" },

    /* action buttons gpio defines */  
    {bp_usButtonIdx,             .u.us = 2},
    {bp_usButtonExtIntr,         .u.us = BP_EXT_INTR_2|BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE|BP_EXT_INTR_TYPE_IRQ_LOW_LEVEL},
    {bp_usGpio_Intr,             .u.us = BP_GPIO_21_AL},
    {bp_usButtonAction,          .u.us = BP_BTN_ACTION_HOTPLUG_EVENT | BP_BTN_TRIG_PRESS },
    {bp_ulButtonActionParm,      .u.ptr = (void*)"alexa_action pressed" },
    {bp_usButtonAction,          .u.us = BP_BTN_ACTION_HOTPLUG_EVENT | BP_BTN_TRIG_RELEASE | BP_BTN_TRIG_0S},
    {bp_ulButtonActionParm,      .u.ptr = (void*)"alexa_action released" },
#endif

    /* led gpio defines, high level active */
    {bp_usGpioLedRed,             .u.us = BP_GPIO_2_AL},
    {bp_usGpioLedGreen,           .u.us = BP_GPIO_1_AL},
    {bp_usGpioLedBlue,            .u.us = BP_GPIO_0_AL},
    {bp_usGpioLedColorful,        .u.us = BP_GPIO_27_AL},
#if defined(CONFIG_TP_MODEL_VOICE_X20V1)
    /* mute led gpio defines */
    {bp_usGpioLedMute,            .u.us = BP_GPIO_26_AL},
    /* speaker_en for PA */
    {bp_usGpioSpeakerEn,          .u.us = BP_GPIO_20_AH},
    {bp_usGpioMiscButtonReset,    .u.us = BP_GPIO_38_AH},
    {bp_usGpioBtReset,           .u.us = BP_GPIO_35_AH},
    /* misc button IRQ */
    {bp_usExtIntrMiscButton,      .u.us = BP_EXT_INTR_3|BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE|BP_EXT_INTR_TYPE_IRQ_LOW_LEVEL},
    {bp_usGpio_Intr,              .u.us = BP_GPIO_39_AL},
#endif
#endif
...
static bp_elem_t g_Deco_X70_V1[] = {
    {bp_cpBoardId,               .u.cp = "Deco_X70_V1"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
    ...
    /* led gpio defines, high level active */
    {bp_usGpioLedRed,             .u.us = BP_GPIO_11_AH},
    {bp_usGpioLedGreen,           .u.us = BP_GPIO_12_AH},
    {bp_usGpioLedBlue,            .u.us = BP_GPIO_22_AH},
    {bp_usGpioLedColorful,        .u.us = BP_GPIO_8_AH},

    {bp_ReservedAnyGpio,          .u.us = BP_GPIO_25_AH},
    {bp_ReservedAnyGpio,          .u.us = BP_GPIO_33_AH},
    {bp_ReservedAnyGpio,          .u.us = BP_GPIO_34_AH},
#endif
...
static bp_elem_t g_Deco_X70_plus[] = {
    {bp_cpBoardId,               .u.cp = "Deco_X70Plus"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
...
#if 0
static bp_elem_t g_Deco_AX2700_2Ge[] = {
    {bp_cpBoardId,               .u.cp = "Deco_AX2700_2Ge"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
...
//	{bp_usConfigType,		.u.us	= BP_ENET_CONFIG_MDIO},
//	{bp_ucPhyType1,			.u.uc	= BP_ENET_NO_PHY},
//	{bp_ucPhyType1,			.u.uc	= BP_ENET_INTERNAL_PHY},
//	{bp_ucPhyType1,			.u.uc	= BP_ENET_EXTERNAL_SWITCH},
        {bp_ulPhyId1,                .u.ul = BP_PHY_ID_NOT_SPECIFIED},
        {bp_ulCrossbar,              .u.ul = BP_CROSSBAR_PORT_BASE+1},
//	 {bp_ucPhyAddress,            .u.uc = 0x18},
        {bp_ulCrossbarPhyId,         .u.ul = 0x18 |  PHY_INTEGRATED_VALID | MAC_IF_RGMII_3P3V | PHY_EXTERNAL},
		// GPIO10 is designed for the 53134 switch reset
		{bp_usGpioInitState,         .u.us = BP_GPIO_10_AH},
...
/*******************************************************
this is for SP1 of AX2700(lileiyang)
PHY(53134 switch) reset without gpio, so no need to
{bp_usGpioInitState,         .u.us = BP_GPIO_10_AH},
********************************************************/
static bp_elem_t g_Deco_AX2700_SP1[] = {
    {bp_cpBoardId,               .u.cp = "AX2700_SP1"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
...
//  {bp_ucPhyType1,         .u.uc   = BP_ENET_EXTERNAL_SWITCH},
        ...
        {bp_ulCrossbar,              .u.ul = BP_CROSSBAR_PORT_BASE+1},
//   {bp_ucPhyAddress,            .u.uc = 0x18},
        {bp_ulCrossbarPhyId,         .u.ul = 0x1e |  PHY_INTEGRATED_VALID | MAC_IF_RGMII_3P3V | PHY_EXTERNAL},
...
*/
//        {bp_ulPortFlags,             .u.ul = PORT_FLAG_SWAP_PAIR},
//  {bp_usGpioPhyReset,     .u.us = BP_GPIO_15_AH},
 ...
 *  {bp_ulPortMap,               .u.ul = 0x03},
 *  {bp_ulPhyId0,                .u.ul = (BCM947622_PHY_BASE + 0x00) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
 *  {bp_ulPhyId1,                .u.ul = (BCM947622_PHY_BASE + 0x01) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
 *  */
    /* use slower ddr clock in 6755 chip for now. May bump up to 1067MHz if test pass */
    {bp_ulMemoryConfig,          .u.ul = BP_DDR_SPEED_800_11_11_11 | BP_DDR_TOTAL_SIZE_256MB| BP_DDR_DEVICE_WIDTH_16 | BP_DDR_TOTAL_WIDTH_16BIT | BP_DDR_SSC_CONFIG_1},
//    {bp_elemTemplate,            .u.bp_elemp = g_bcm947622ref1},
...
static bp_elem_t g_Deco_X90V1[] = {
    {bp_cpBoardId,               .u.cp = "Deco_X90V1"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
    ...
    {bp_ulPhyId0,                .u.ul = (BCM947622_PHY_BASE + 0x00) | (ADVERTISE_ALL_GMII | PHY_ADV_CFG_VALID)},
    {bp_ulPhyId1,                .u.ul = 6 |  PHY_INTEGRATED_VALID | MAC_IF_SERDES},
    {bp_ulPhyId1,                .u.ul = 0x1e | PHY_EXTERNAL | PHY_TYPE_CL45GPHY},
    {bp_ulPortFlags,             .u.ul = PORT_FLAG_SWAP_PAIR},
...
static bp_elem_t g_Deco_X90V1_256M[] = {
    {bp_cpBoardId,               .u.cp = "X90V1_256M"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
...
static bp_elem_t g_X90V1_SP2[] = {
    {bp_cpBoardId,               .u.cp = "X90V1_SP2"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
...
static bp_elem_t g_Deco_X90V1_NO_ETH1[] = {
    {bp_cpBoardId,               .u.cp = "Deco_X90V1_1ETH"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
...
/* Archer AX6600: 25G(BCM54991E) + BCM53134 */
static bp_elem_t g_Archer_AX6600[] = {
    {bp_cpBoardId,               .u.cp = "Archer_AX6600"},
    {bp_ulCompatChipId,          .u.ul = 0x47622},  /* remove this line when chip id is otp'ed to 0x6755 */
    {bp_ulCompatChipId,          .u.ul = 0x6755},
    ...
    {bp_ulPhyId0,                .u.ul = RGMII_DIRECT_3P3V | EXTSW_CONNECTED},
    {bp_ulPortFlags,             .u.ul = PORT_FLAG_TX_INTERNAL_DELAY | PORT_FLAG_RX_INTERNAL_DELAY},
    {bp_ucPhyType1,              .u.uc = BP_ENET_EXTERNAL_SWITCH},
    {bp_ucPhyAddress,            .u.uc = 0x0},
    {bp_usConfigType,            .u.us = BP_ENET_CONFIG_MDIO},
...
bp_elem_t * g_BoardParms[] = {g_bcm947622sv, g_bcm947622sv_otp, g_bcm947622rfdvt, g_bcm947622rfdvt2, g_bcm947622ref1, g_bcm96755ref1, g_bcm947622eap, g_bcm947622eap2, g_bcm947622eaps, \
    g_bcm947622sv_serdes, g_bcm947622ref1_sg, g_bcm96755ref1_sg, g_bcm96755tbrhx, /*g_bcm947622ref1_p250, g_bcm947622ref1_sg_p250, g_bcm96755ref1_p200, g_bcm96755ref1_sg_p200,*/ \
    g_Archer_AX1800_2Ge, g_Deco_AX1800_2Ge, g_Deco_X20_V2, g_Deco_Voice_X20_V1, g_Deco_X70_V1, g_Deco_X70_plus, \
    /* g_RE_AX1800_2Ge, \ */
    g_Deco_X90V1, g_Deco_X90V1_256M, g_X90V1_SP2, g_Deco_X90V1_NO_ETH1, g_Archer_AX6600, \
    /* g_Deco_AX2700_2Ge, g_Deco_AX2700_SP1, \ */
    g_bcm96755ref2, g_bcm947622leap, /*g_bcm96755ref1t_sg,*/ \
    0};
