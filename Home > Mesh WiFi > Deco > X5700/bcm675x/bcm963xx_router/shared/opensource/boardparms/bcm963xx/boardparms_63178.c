...
static bp_elem_t g_bcm96750_x6v1[] = {
  {bp_cpBoardId,               .u.cp = "TP6750_X6V1"},
  ...
  {bp_ulButtonActionParm,      .u.ptr = (void*)"reset released" },
   ...
   /* led gpio defines */
   /* GPIO_00 Reset Button GPIO_05:LED_RED GPIO_06:LED_GREEN GPIO_07:LED_BLUE */
  {bp_usGpioLedRed,             .u.us = BP_GPIO_5_AL},
  {bp_usGpioLedGreen,           .u.us = BP_GPIO_6_AL},
  {bp_usGpioLedBlue,            .u.us = BP_GPIO_7_AL},
  {bp_usGpioLedColorful,        .u.us = BP_GPIO_8_AL},
    ...
    {bp_usGpio_Intr,              .u.us = BP_GPIO_0_AL},      /* reset button */
#endif
...
static bp_elem_t g_TP6750[] = {
  {bp_cpBoardId,               .u.cp = "TP6750"},
  {bp_usButtonIdx,             .u.us = 0},
  {bp_usButtonExtIntr,         .u.us = BP_EXT_INTR_0|BP_EXT_INTR_TYPE_IRQ_SENSE_EDGE|BP_EXT_INTR_TYPE_IRQ_LOW_LEVEL},
  {bp_usGpio_Intr,             .u.us = BP_GPIO_0_AL},
  {bp_usButtonAction,          .u.us = BP_BTN_ACTION_PRINT | BP_BTN_TRIG_PRESS },
