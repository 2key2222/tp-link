...
#else
 MAP( bp_usGpioLedRed,  red),
 MAP( bp_usGpioLedGreen, green),
 MAP( bp_usGpioLedBlue, blue),
 MAP( bp_usGpioLedColorful, colorful),
#if defined(CONFIG_TP_MODEL_VOICE_X20V1)
 MAP( bp_usGpioLedMute, mute),
#endif
#endif
 {-1, NULL}
};
...
int BpGetRedLedGpio( unsigned short *pusValue )
{
    return ( BpGetGpio(bp_usGpioLedRed, pusValue ) );
} 

int BpGetGreenLedGpio( unsigned short *pusValue )
{
    return ( BpGetGpio(bp_usGpioLedGreen, pusValue ) );
} 

int BpGetBlueLedGpio( unsigned short *pusValue )
{
    return ( BpGetGpio(bp_usGpioLedBlue, pusValue ) );
}

int BpGetColorfulLedGpio( unsigned short *pusValue )
{
    return ( BpGetGpio(bp_usGpioLedColorful, pusValue ) );
}

#if defined(CONFIG_TP_MODEL_VOICE_X20V1)
int BpGetSpeakerEnGpio( unsigned short *pusValue )
{
	return ( BpGetGpio(bp_usGpioSpeakerEn, pusValue) );
}

int BpGetMiscButtonResetGpio( unsigned short *pusValue )
{
	return ( BpGetGpio(bp_usGpioMiscButtonReset, pusValue) );
}

int BpGetMiscButtonExtIntr( unsigned short *pusValue )
{
    return( BpGetUs(bp_usExtIntrMiscButton, pusValue ) );
} /* BpGetMiscButtonExtIntr */

int BpGetMiscButtonExtIntrGpio( unsigned short *pusValue )
{
    int ret;
    ...
    ret = BpGetExtIntrGpio(bp_usExtIntrMiscButton, pusValue);
    
    return( ret );  
} /* BpGetMiscButtonExtIntrGpio */
#endif
