...
let ocamlc_path     = "/usr/bin/ocamlc"
let ocamlopt_path   = "/usr/bin/ocamlopt"
let ocamldep_path   = "/usr/bin/ocamldep"
let ocamldoc_path   = "/usr/bin/ocamldoc"
let ocamlyacc_path  = "/usr/bin/ocamlyacc"
let ocamllex_path   = "/usr/bin/ocamllex"
let ocamlmklib_path = "/usr/bin/ocamlmklib"
let ocamlmktop_path = "/usr/bin/ocamlmktop"
let camlp4o_path    = "/usr/bin/camlp4o"
let menhir_path     = "/home/ubuntu/Archer_C7_V5/openwrt/build_dir/host/coccinelle-coccinelle-1.0.0-rc21/setup/fake-menhir.sh menhir"

let pycaml_path     = ""
let pcre_path       = ""
let menhirLib_path  = "/home/ubuntu/Archer_C7_V5/openwrt/build_dir/host/coccinelle-coccinelle-1.0.0-rc21/bundles/menhirLib/"
let dynlink_path    = ""
