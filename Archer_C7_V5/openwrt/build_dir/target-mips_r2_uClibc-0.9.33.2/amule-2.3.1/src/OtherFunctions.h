...
#define MAX_CLIENT_PUB_KEY_LEN 80
#define MAX_CLIENT_SIGN_KEY_LEN 512
#define MAX_CLIENT_BASE64_SIGN_KEY_LEN MAX_CLIENT_SIGN_KEY_LEN*2

#ifdef ENABLE_TOMCRYPT
enum DER_CODE_TYPE
{
	DER_FULL_CODE_TYPE,
	DER_STRIPPED_CODE_TYPE
};

int rsa_der_export(unsigned char *out, unsigned long *outlen, 
					int keytype, int dertype, void *key);

int rsa_der_import(const unsigned char *in, unsigned long inlen, 
					int keytype, int dertype, void *key);
