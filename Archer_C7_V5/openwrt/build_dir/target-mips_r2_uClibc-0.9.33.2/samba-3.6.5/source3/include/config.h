...
#define STRING_STATIC_MODULES " pdb_smbpasswd idmap_tdb idmap_passdb auth_sam auth_unix auth_server auth_builtin vfs_default"
...
#define static_decl_auth extern NTSTATUS auth_sam_init(void); extern NTSTATUS auth_unix_init(void); extern NTSTATUS auth_server_init(void); extern NTSTATUS auth_builtin_init(void);
...
/* Decl of Static init functions */
#define static_decl_idmap extern NTSTATUS idmap_tdb_init(void); extern NTSTATUS idmap_passdb_init(void);

/* Decl of Static init functions */
#define static_decl_nss_info 

/* Decl of Static init functions */
#define static_decl_pdb extern NTSTATUS pdb_smbpasswd_init(void);
...
#define static_init_auth {  auth_sam_init();  auth_unix_init();  auth_server_init();  auth_builtin_init();}
...
/* Static init functions */
#define static_init_idmap {  idmap_tdb_init();  idmap_passdb_init();}
