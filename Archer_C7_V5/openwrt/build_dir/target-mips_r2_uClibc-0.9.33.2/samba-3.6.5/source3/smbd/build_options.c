...
/* Output various other options (as gleaned from include/config.h.in) */
	...
	output(screen, "   HAVE_FALLOCATE64\n");
#endif
...
#endif
#ifdef HAVE_FDOPENDIR64
	output(screen, "   HAVE_FDOPENDIR64\n");
#endif
#ifdef HAVE_FGETEA
...
#endif
#ifdef HAVE_LINUX_FALLOCATE64
	output(screen, "   HAVE_LINUX_FALLOCATE64\n");
#endif
	...
	output(screen, "   HAVE_POSIX_FALLOCATE64\n");
#endif
...
#endif
#ifdef HAVE_TDB_ERR_NESTING
	output(screen, "   HAVE_TDB_ERR_NESTING\n");
#endif
...
#endif
#ifdef auth_netlogond_init
	output(screen, "   auth_netlogond_init\n");
#endif
#ifdef auth_sam_init
...
#endif
#ifdef perfcount_onefs_init
	output(screen, "   perfcount_onefs_init\n");
#endif
...
#endif
#ifdef vfs_gpfs_hsm_notify_init
	output(screen, "   vfs_gpfs_hsm_notify_init\n");
#endif
#ifdef vfs_gpfs_init
...
#endif
#ifdef vfs_onefs_init
	output(screen, "   vfs_onefs_init\n");
#endif
#ifdef vfs_onefs_shadow_copy_init
	output(screen, "   vfs_onefs_shadow_copy_init\n");
#endif
