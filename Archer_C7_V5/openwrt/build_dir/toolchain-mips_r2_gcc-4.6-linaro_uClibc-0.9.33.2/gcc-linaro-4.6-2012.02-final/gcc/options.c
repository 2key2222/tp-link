...
const struct gcc_options global_options_init =
{
  ...
  0, /* inhibit_warnings */
  0, /* wrapper_string */
  0, /* VAR_mabi_ (private state) */
#undef x_VAR_mabi_
  0, /* VAR_mcode_readable_ (private state) */
#undef x_VAR_mcode_readable_
  0, /* VAR_mips (private state) */
#undef x_VAR_mips
  0, /* VAR_mmips_tfile (private state) */
#undef x_VAR_mmips_tfile
  0, /* VAR_mno_flush_func (private state) */
#undef x_VAR_mno_flush_func
  0, /* VAR_mr10k_cache_barrier_ (private state) */
#undef x_VAR_mr10k_cache_barrier_
...
const struct cl_option cl_options[] =
{
  ...
  { "-G",
    ...
    0,
    NULL, NULL, N_OPTS, N_OPTS, 1, -1,
    CL_TARGET | CL_JOINED | CL_SEPARATE | CL_UINTEGER,
  ...
  { "-Waggregate-return",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 161,
    CL_COMMON | CL_WARNING,
  ...
  { "-Walign-commons",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 163,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wall",
  ...
  { "-Wall-deprecation",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 165,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wall-javadoc",
    0,
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 166,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wampersand",
  ...
  { "-Warray-bounds",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 168,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wattributes",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 172,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wchar-concat",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 180,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wchar-subscripts",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 181,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wcharacter-truncation",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 182,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wclobbered",
  ...
  { "-Wcomments",
    ...
    0,
    0,
    NULL, NULL, OPT_Wcomment, N_OPTS, 9, 185,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wcondition-assign",
    0,
  ...
  { "-Wconversion-extra",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 189,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wconversion-null",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 190,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wctor-dtor-privacy",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 193,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wdeclaration-after-statement",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 194,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Werror-maybe-reset",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 211,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Werror=",
  ...
  { "-Wforbidden",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 221,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wformat",
  ...
  { "-Wformat-contains-nul",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 223,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wformat-nonliteral",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 225,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wformat-security",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 226,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wformat-y2k",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 227,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Winvalid-pch",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 248,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wjavadoc",
    0,
  ...
  { "-Wjump-misses-init",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 250,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wlocal-hiding",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 255,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wlogical-op",
  ...
  { "-Wmasked-catch-block",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 259,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wmissing-braces",
  ...
  { "-Wmissing-field-initializers",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 27, 262,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wmissing-format-attribute",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 263,
    CL_Ada | CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wmissing-parameter-type",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 266,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wmissing-prototypes",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 267,
  ...
  { "-Wmultichar",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 269,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wnested-externs",
  ...
  { "-Wold-style-cast",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 279,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wold-style-declaration",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 280,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wold-style-definition",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 281,
    CL_Ada | CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wout-of-date",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 282,
    CL_Java,
  ...
  { "-Woverlength-strings",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 285,
    CL_Ada | CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Woverloaded-virtual",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 286,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Woverride-init",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 287,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wpacked-bitfield-compat",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 290,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wparam-assign",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 292,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wparentheses",
  ...
  { "-Wpmf-conversions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 295,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wpointer-sign",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 297,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wpointer-to-int-cast",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 298,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wproperty-assign-default",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 300,
    CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wreal-q-constant",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 304,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wredundant-decls",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 305,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wredundant-modifiers",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 306,
    CL_Java,
  ...
  { "-Wsign-promo",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 315,
    CL_CXX | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wstatic-access",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 318,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wstatic-receiver",
    0,
  ...
  { "-Wstrict-prototypes",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 325,
    CL_Ada | CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wsuggest-attribute=const",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 327,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wsuggest-attribute=pure",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 329,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wswitch-default",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 333,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wsync-nand",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 335,
    CL_C | CL_CXX | CL_WARNING,
  ...
  { "-Wsynthetic-access",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 337,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wsystem-headers",
  ...
  { "-Wtraditional-conversion",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 342,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wtrigraphs",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 344,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wtype-hiding",
    0,
  ...
  { "-Wundeclared-selector",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 348,
    CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wuninitialized",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 351,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wunknown-pragmas",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 352,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wunnecessary-else",
    0,
  ...
  { "-Wunreachable-code",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 355,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wunsafe-loop-optimizations",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 356,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wunsuffixed-float-constants",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 27, 357,
    CL_C | CL_ObjC | CL_WARNING,
  ...
  { "-Wunused-but-set-parameter",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 360,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wunused-but-set-variable",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 361,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wunused-dummy-argument",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 362,
    CL_Fortran | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wunused-function",
  ...
  { "-Wunused-local",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 366,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wunused-macros",
  ...
  { "-Wunused-parameter",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 368,
    CL_COMMON | CL_WARNING,
  ...
  { "-Wunused-result",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 370,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-Wvarargs-cast",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 375,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wvariadic-macros",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 376,
    CL_Ada | CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-Wvla",
  ...
  { "-Wvolatile-register-var",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 378,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_WARNING,
  ...
  { "-cpp=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 4, 1025,
  ...
  { "-falign-commons",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 412,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-falign-functions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 413,
  ...
  { "-falign-jumps",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 415,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fall-virtual",
    ...
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 12, 422,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fallow-leading-underscore",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 423,
  ...
  { "-falt-external-templates",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 23, 424,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fargument-alias",
    "Does nothing. Preserved for backward compatibility.",
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 425,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fargument-noalias",
    "Does nothing. Preserved for backward compatibility.",
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 426,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fargument-noalias-anything",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 26, 427,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fargument-noalias-global",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 24, 428,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fasm",
  ...
  { "-fassociative-math",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 431,
    CL_COMMON | CL_REPORT,
  ...
  { "-fassume-compiled=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 433,
  ...
  { "-fasynchronous-unwind-tables",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 27, 434,
  ...
  { "-fbackslash",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 438,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fbacktrace",
  ...
  { "-fbootstrap-classes",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 442,
    CL_Java,
  ...
  { "-fbranch-probabilities",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 445,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fbranch-target-load-optimize",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 446,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fbranch-target-load-optimize2",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 447,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fbtr-bb-exclusive",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 448,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fcheck-array-temporaries",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 454,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fcheck-data-deps",
  ...
  { "-fcheck-new",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 456,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fcompare-debug",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 463,
    CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fconserve-stack",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 470,
    CL_COMMON | CL_OPTIMIZATION,
  ...
  { "-fcprop-registers",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 477,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fcse-skip-blocks",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 16, 481,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fcx-fortran-rules",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 482,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fdefault-inline",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 493,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdefault-integer-8",
  ...
  { "-fdefault-real-8",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 495,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdefer-pop",
  ...
  { "-fdelayed-branch",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 497,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fdelete-null-pointer-checks",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 27, 498,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fdiagnostics-show-option",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 501,
    CL_COMMON,
  ...
  { "-fdisable-assertions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 503,
    CL_Java,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdisable-assertions=",
    0,
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 504,
    CL_Java | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-fdollar-ok",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 505,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fdump-core",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 10, 509,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdump-final-insns",
    0,
  ...
  { "-fdump-fortran-optimized",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 23, 512,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdump-fortran-original",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 22, 513,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdump-go-spec=",
  ...
  { "-fdump-noaddr",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 12, 515,
    CL_COMMON | CL_REPORT,
  ...
  { "-fdump-parse-tree",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 16, 516,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fdump-unnumbered",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 16, 517,
    CL_COMMON | CL_REPORT,
  ...
  { "-fdump-unnumbered-links",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_fdump_, 22, 518,
    CL_COMMON | CL_REPORT,
  ...
  { "-fdwarf2-cfi-asm",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 519,
    CL_COMMON | CL_REPORT,
  ...
  { "-fearly-inlining",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 520,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-felide-constructors",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 521,
    CL_CXX | CL_ObjCXX,
  ...
  { "-feliminate-dwarf2-dups",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 522,
    CL_COMMON | CL_REPORT,
  ...
  { "-feliminate-unused-debug-symbols",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 523,
    CL_COMMON | CL_REPORT,
  ...
  { "-feliminate-unused-debug-types",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 524,
  ...
  { "-femit-class-debug-always",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 525,
    CL_COMMON | CL_REPORT,
  ...
  { "-femit-class-file",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 526,
    CL_Java,
  ...
  { "-femit-struct-debug-baseonly",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 27, 528,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-femit-struct-debug-detailed=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 529,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED,
    -1, 0, CLVC_STRING, 0 },
  { "-femit-struct-debug-reduced",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 530,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fenable-assertions",
    0,
  ...
  { "-fenable-assertions=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 532,
    CL_Java | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-fenable-icf-debug",
  ...
  { "-fexceptions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 537,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fexternal-templates",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 19, 544,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ff2c",
  ...
  { "-ffast-math",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 546,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ffilelist-file",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 547,
    CL_Java,
  ...
  { "-ffinite-math-only",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 548,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ffloat-store",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 553,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fforce-addr",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 11, 555,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fforce-classes-archive-check",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 556,
    CL_Java,
  ...
  { "-ffreestanding",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 563,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ffriend-injection",
  ...
  { "-fgcse-after-reload",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 568,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fgnu-keywords",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 572,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fgnu-runtime",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 573,
    CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fgnu89-inline",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 574,
    CL_C | CL_ObjC,
  ...
  { "-fguess-branch-probability",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 579,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fguiding-decls",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 14, 580,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fhandle-exceptions",
    0,
    ...
    NULL, NULL, OPT_fexceptions, N_OPTS, 18, 581,
  ...
  { "-fhelp",
    ...
    0,
    0,
    NULL, NULL, OPT__help, N_OPTS, 5, 583,
    CL_COMMON | CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fhelp=",
    0,
    0,
    0,
    NULL, NULL, OPT__help_, N_OPTS, 6, 584,
  ...
  { "-fhonor-std",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 10, 585,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fhonour-copts",
    0,
  ...
  { "-fhuge-objects",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 13, 588,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fident",
  ...
  { "-fimplicit-inline-templates",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 593,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fimplicit-none",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 594,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fimplicit-templates",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 595,
    CL_CXX | CL_ObjCXX,
  ...
  { "-findirect-inlining",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 598,
    CL_COMMON | CL_REPORT,
  ...
  { "-finline-functions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 606,
  ...
  { "-finline-functions-called-once",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 607,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-finstrument-functions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 612,
    CL_COMMON | CL_REPORT,
  ...
  { "-fipa-profile",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 619,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fipa-pure-const",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 621,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fipa-reference",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 622,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fipa-struct-reorg",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 624,
    CL_COMMON | CL_REPORT,
  ...
  { "-fira-loop-pressure",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 626,
    CL_COMMON | CL_REPORT,
  ...
  { "-fira-share-spill-slots",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 629,
    CL_COMMON | CL_REPORT,
  ...
  { "-fjump-tables",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 633,
    CL_COMMON | CL_OPTIMIZATION,
  ...
  { "-fkeep-inline-dllexport",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 634,
  ...
  { "-fkeep-inline-functions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 635,
    CL_COMMON | CL_REPORT,
  ...
  { "-fkeep-static-consts",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 636,
    CL_COMMON | CL_REPORT,
  ...
  { "-flax-vector-conversions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 638,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-fleading-underscore",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 639,
    CL_COMMON | CL_REPORT,
  ...
  { "-floop-block",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 640,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-floop-parallelize-all",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 644,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-floop-strip-mine",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 645,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-flto-report",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 651,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fmath-errno",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 656,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fmerge-all-constants",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 663,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fmerge-constants",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 664,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fmerge-debug-strings",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 665,
    CL_COMMON | CL_REPORT,
  ...
  { "-fmodule-private",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 667,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fmodulo-sched",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 668,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fmodulo-sched-allow-regmoves",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 669,
    CL_COMMON | CL_REPORT,
  ...
  { "-fname-mangling-version-",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 23, 675,
  ...
  { "-fnew-abi",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 8, 676,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fnext-runtime",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 677,
    CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fnil-receivers",
  ...
  { "-fnon-call-exceptions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 679,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fnonnull-objects",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 16, 681,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fnothrow-opt",
  ...
  { "-fobjc-call-cxx-cdtors",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 684,
    CL_ObjCXX,
  ...
  { "-fobjc-sjlj-exceptions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 689,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-foperator-names",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 693,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-foptimize-register-move",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 694,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-foptimize-static-class-initialization",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 37, 696,
    CL_Java,
  ...
  { "-foptional-diags",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 697,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-foutput-class-dir=",
    0,
  ...
  { "-fpack-struct",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 700,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fpcc-struct-return",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 703,
    CL_COMMON | CL_REPORT,
  ...
  { "-fpch-preprocess",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 705,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fpeel-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 706,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fpeephole2",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 708,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fpermissive",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 709,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fpic",
  ...
  { "-fpost-ipa-mem-report",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 715,
    CL_COMMON | CL_REPORT,
  ...
  { "-fpredictive-commoning",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 717,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fprefetch-loop-arrays",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 718,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fpreprocessed",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 719,
    CL_C | CL_CXX | CL_Fortran | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fpretty-templates",
  ...
  { "-fprofile-values",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 729,
    CL_COMMON | CL_REPORT,
  ...
  { "-frealloc-lhs",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 734,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-freciprocal-math",
  ...
  { "-frecursive",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 739,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-freduced-reflection",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 740,
    CL_Java,
  ...
  { "-freg-struct-return",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 741,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-freorder-blocks",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 744,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-freorder-blocks-and-partition",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 745,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-frepack-arrays",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 747,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-freplace-objc-classes",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 748,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-frequire-return-statement",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 750,
    CL_Go | CL_WARNING,
  ...
  { "-frerun-cse-after-loop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 751,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-frerun-loop-opt",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 752,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-freschedule-modulo-scheduled-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 34, 753,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-frounding-math",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 755,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-critical-path-heuristic",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 30, 758,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-dep-count-heuristic",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 759,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-group-heuristic",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 760,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-interblock",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 761,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-spec",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 765,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-spec-load",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 767,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-spec-load-dangerous",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 768,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-stalled-insns",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 769,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-stalled-insns-dep",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 770,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched2-use-traces",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 18, 775,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fschedule-insns",
  ...
  { "-fschedule-insns2",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 777,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsection-anchors",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 779,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsee",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 4, 780,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fsel-sched-pipelining-outer-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 33, 782,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsel-sched-reschedule-pipelined",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 783,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fshort-enums",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 787,
  ...
  { "-fsign-zero",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 790,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fsignaling-nans",
  ...
  { "-fsigned-zeros",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 794,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsingle-precision-constant",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 795,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsplit-ivs-in-unroller",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 798,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsplit-stack",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 799,
    CL_COMMON | CL_REPORT,
  ...
  { "-fsquangle",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 9, 801,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstack-check",
  ...
  { "-fstore-check",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 811,
    CL_Java,
  ...
  { "-fstrength-reduce",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 16, 812,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstrict-aliasing",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 813,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fstrict-enums",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 814,
    CL_CXX | CL_ObjCXX | CL_OPTIMIZATION,
  ...
  { "-fstrict-overflow",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 815,
    CL_COMMON | CL_REPORT,
  ...
  { "-fstrict-prototype",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 816,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstrict-volatile-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 817,
    CL_COMMON | CL_REPORT,
  ...
  { "-ftrapping-math",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 832,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-builtin-call-dce",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 835,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-copy-prop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 838,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-cselim",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 840,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-distribute-patterns",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 30, 846,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-if-convert-stores",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 849,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-im",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 850,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-linear",
    ...
    0,
    0,
    NULL, NULL, OPT_floop_interchange, N_OPTS, 17, 852,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-loop-optimize",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 853,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-salias",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 12, 860,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-scev-cprop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 861,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-slp-vectorize",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 863,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-store-copy-prop",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 21, 866,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-switch-conversion",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 867,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funroll-all-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 875,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funsafe-loop-optimizations",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 877,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funsafe-math-optimizations",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 878,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funsigned-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 879,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-funwind-tables",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 882,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fuse-atomic-builtins",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 883,
    CL_Java,
  ...
  { "-fuse-cxa-atexit",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 885,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fuse-divide-subroutine",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 887,
    CL_Java,
  ...
  { "-fuse-linker-plugin",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 888,
  ...
  { "-fvar-tracking-assignments",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 890,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvar-tracking-assignments-toggle",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 32, 891,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvar-tracking-uninit",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 892,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvariable-expansion-in-unroller",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 893,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvect-cost-model",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 894,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fversion",
    ...
    0,
    0,
    NULL, NULL, OPT__version, N_OPTS, 8, 896,
    CL_COMMON | CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fvisibility-inlines-hidden",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 897,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fvisibility-ms-compat",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 898,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fvtable-gc",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 10, 901,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fvtable-thunks",
    "No longer supported",
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 14, 902,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fweak",
  ...
  { "-fwhole-file",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 905,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fwhole-program",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 906,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fworking-directory",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 908,
    CL_C | CL_CXX | CL_Fortran | CL_ObjC | CL_ObjCXX,
  ...
  { "-fxref",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 5, 911,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fzee",
  ...
  { "-fzero-initialized-in-bss",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 913,
    CL_COMMON | CL_REPORT,
  ...
  { "-fzero-link",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 914,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-gstabs+",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_gstabs, 7, 928,
    CL_COMMON | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-gstrict-dwarf",
  ...
  { "-gxcoff+",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_gxcoff, 7, 917,
    CL_COMMON | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-h",
    0,
  ...
  { "-mabi=",
    ...
    offsetof (struct gcc_options, x_VAR_mabi_), 0, CLVC_STRING, 0 },
  { "-mabicalls",
    "Generate code that can be used in SVR4-style dynamic objects",
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 9, 947,
    CL_TARGET | CL_REPORT,
  ...
  { "-march=",
    ...
    NULL, NULL, N_OPTS, N_OPTS, 6, -1,
    CL_TARGET | CL_JOINED | CL_REJECT_NEGATIVE,
    offsetof (struct gcc_options, x_mips_arch_string), 0, CLVC_STRING, 0 },
  { "-mbionic",
    "Use Bionic C library",
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 7, 982,
  ...
  { "-mbranch-likely",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 953,
    CL_TARGET | CL_REPORT,
  ...
  { "-mcode-readable=",
    ...
    NULL, NULL, N_OPTS, N_OPTS, 15, -1,
    CL_TARGET | CL_JOINED | CL_REJECT_NEGATIVE,
    offsetof (struct gcc_options, x_VAR_mcode_readable_), 0, CLVC_STRING, 0 },
  { "-mdebug",
    0,
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 6, 956,
  ...
  { "-membedded-data",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 966,
    CL_TARGET | CL_REPORT,
  ...
  { "-mextern-sdata",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 968,
    CL_TARGET | CL_REPORT,
  ...
  { "-mfix-r4000",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 970,
    CL_TARGET | CL_REPORT,
  ...
  { "-mfix-vr4120",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 973,
    CL_TARGET | CL_REPORT,
  ...
  { "-mflip-mips16",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 976,
    CL_TARGET | CL_REPORT,
  ...
  { "-mfp-exceptions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 978,
    CL_TARGET | CL_REPORT,
  ...
  { "-mfused-madd",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 981,
    CL_TARGET | CL_REPORT,
  ...
  { "-mips",
    ...
    NULL, NULL, N_OPTS, N_OPTS, 4, -1,
    CL_TARGET | CL_JOINED | CL_REJECT_NEGATIVE,
    offsetof (struct gcc_options, x_VAR_mips), 0, CLVC_STRING, 0 },
  { "-mips16",
  ...
  { "-mmcount-ra-address",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 996,
    CL_TARGET | CL_REPORT,
  ...
  { "-mmips-tfile",
    ...
    CL_TARGET,
    offsetof (struct gcc_options, x_VAR_mmips_tfile), 0, CLVC_BOOLEAN, 0 },
  { "-mmt",
    "Allow the use of MT instructions",
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 3, 999,
    CL_TARGET | CL_REPORT,
  ...
  { "-mpaired-single",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 1005,
    CL_TARGET | CL_REPORT,
  ...
  { "-mr10k-cache-barrier=",
    ...
    NULL, NULL, N_OPTS, N_OPTS, 20, -1,
    CL_TARGET | CL_JOINED | CL_REJECT_NEGATIVE,
    offsetof (struct gcc_options, x_VAR_mr10k_cache_barrier_), 0, CLVC_STRING, 0 },
  { "-mrelax-pic-calls",
    "Try to allow the linker to turn PIC calls into direct calls",
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 1008,
    CL_TARGET | CL_REPORT,
  ...
  { "-mshared",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 7, 1009,
    CL_TARGET | CL_REPORT,
  ...
  { "-msmartmips",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 1011,
    CL_TARGET | CL_REPORT,
  ...
  { "-msplit-addresses",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 1013,
    CL_TARGET | CL_REPORT,
  ...
  { "-msym32",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 6, 1014,
    CL_TARGET | CL_REPORT,
  ...
  { "-mtune=",
    ...
    NULL, NULL, N_OPTS, N_OPTS, 6, -1,
    CL_TARGET | CL_JOINED | CL_REJECT_NEGATIVE,
    offsetof (struct gcc_options, x_mips_tune_string), 0, CLVC_STRING, 0 },
  { "-muclibc",
    "Use uClibc C library",
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 7, 951,
    CL_TARGET | CL_REJECT_NEGATIVE | CL_REPORT,
  ...
  { "-muninit-const-in-rodata",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 1018,
    CL_TARGET | CL_REPORT,
  ...
  { "-mvr4130-align",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 1019,
    CL_TARGET | CL_REPORT,
  ...
  { "-pie",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 3, 1060,
    CL_COMMON | CL_REJECT_NEGATIVE,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-pipe",
    0,
  ...
  { "-shared",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 6, 1037,
    CL_COMMON | CL_REJECT_NEGATIVE,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-shared-libgcc",
    0,
