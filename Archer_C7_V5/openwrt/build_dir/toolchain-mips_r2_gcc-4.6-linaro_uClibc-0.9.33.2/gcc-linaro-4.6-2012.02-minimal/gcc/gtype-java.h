...
void
gt_ggc_mx_VEC_method_entry_gc (void *x_p)
{
  struct VEC_method_entry_gc * const x = (struct VEC_method_entry_gc *)x_p;
    ...
    {
      {
        ...
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_9tree_node ((*x).base.vec[i0].method);
          gt_ggc_m_9tree_node ((*x).base.vec[i0].special);
        }
      }
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      switch ((*x).desc)
        {
        case LANG_DECL_FUNC:
          gt_ggc_m_11VEC_tree_gc ((*x).u.f.throws_list);
...
void
gt_pch_nx_VEC_method_entry_gc (void *x_p)
{
  struct VEC_method_entry_gc * const x = (struct VEC_method_entry_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_19VEC_method_entry_gc, gt_ggc_e_19VEC_method_entry_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_9tree_node ((*x).base.vec[i0].method);
          gt_pch_n_9tree_node ((*x).base.vec[i0].special);
        }
      }
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9lang_decl, gt_ggc_e_9lang_decl))
    {
      switch ((*x).desc)
        {
        case LANG_DECL_FUNC:
          gt_pch_n_11VEC_tree_gc ((*x).u.f.throws_list);
...
{
  struct htab * const x = (struct htab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_P14type_assertion4htab, gt_types_enum_last))
    {
      if ((*x).entries != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
...
{
  struct htab * const x = (struct htab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_P18treetreehash_entry4htab, gt_types_enum_last))
    {
      if ((*x).entries != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
...
void
gt_pch_p_19VEC_method_entry_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_method_entry_gc * const x ATTRIBUTE_UNUSED = (struct VEC_method_entry_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).num);
    for (i0 = 0; i0 != l0; i0++) {
      if ((void *)(x) == this_obj)
        op (&((*x).base.vec[i0].method), cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).base.vec[i0].special), cookie);
    }
  }
}
