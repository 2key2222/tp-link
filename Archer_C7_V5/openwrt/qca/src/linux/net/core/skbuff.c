...
#ifndef CONFIG_SKBUFF_RECYCLE_REMOVE
...
static void __copy_skb_header(struct sk_buff *new, const struct sk_buff *old)
{
	...
	/* br-filter flag by tp */
	new->extra_flag	= old->extra_flag;
#ifdef CONFIG_ATHRS17_HNAT
	new->is_from_eth	= old->is_from_eth;
	new->is_hnat_frag	= old->is_hnat_frag;
#endif
#ifdef CONFIG_XFRM
