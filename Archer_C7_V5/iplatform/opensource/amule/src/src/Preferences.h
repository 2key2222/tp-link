...
public:
	...
	static uint32		GetQueueSize() 			{ return s_iQueueSize*50; }
	static void		SetQueueSize(uint32 val)	{ s_iQueueSize = val/50; }
	...
	static uint16 	GetMaxDownloadFileNum() { return s_maxconcurrentdownloads; }
	static void		SetMaxDownloadFileNum(uint16 val) { s_maxconcurrentdownloads = val; }
...
////////////// GUI
	...
	static uint16 s_maxconcurrentdownloads; //added by zengwei
};
