...
CPreciseRateCounter* CStatistics::s_uploadrate;
CPreciseRateCounter* CStatistics::s_downloadrate;
...
CStatistics::CStatistics() 
	{
		s_totalSent = 0;
		s_totalReceived = 0;
		s_downloadrate = new CPreciseRateCounter(30000);
		s_uploadrate = new CPreciseRateCounter(30000);
	}
CStatistics::~CStatistics() 
	{
		delete s_downloadrate;
		delete s_uploadrate;
	}
