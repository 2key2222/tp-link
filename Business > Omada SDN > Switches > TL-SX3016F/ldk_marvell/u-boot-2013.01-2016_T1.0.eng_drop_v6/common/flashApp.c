...
#define DBG(arg...) do{if(flash_app_debug){printf("%s,%d:",__FUNCTION__, __LINE__);printf(arg);}}while(0)
...
/* 默认值为V1.0.0版本 */
LOCAL FLASH_DISTRIBUTE_INFO dftFlashDistributeInfo = {TRUE, 0x10000, 0x100000, 0x100000, 0x600000, 0x700000, 0xa00000, 0x1100000, 0xa00000,0x1B00000, 0x400000};
/* 保存当前系统的FLASH布局信号 */
