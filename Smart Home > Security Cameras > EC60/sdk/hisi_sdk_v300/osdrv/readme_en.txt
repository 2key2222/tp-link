...
The compilation scripts in this directory support the arm-himix100-linux and arm-himix200-linux toolchains. The arm-himix100-linux corresponds to the uclibc library.arm-himix200-linux corresponds to the glibc library. 
The command is as follows (hi3516ev200 is used as an example):
...
Save the downloaded linux-4.9.37.tar.gz file to the opensource/kernel directory of the osdrv.

b:yaffs2utils-0.2.9.tar.gz (https://github.com/dorigom/yaffs2utils/releases)
Save the downloaded yaffs2utils-0.2.9.tar.gz to the tools/pc/mkyaffs2image/ directory of the osdrv.

c:gdb-7.9.1.tar.gz (http://ftp.gnu.org/gnu/gdb/)
Save the downloaded gdb-7.9.1.tar.gz to the tools/board/gdb/ directory of the osdrv.

d:ncurses-6.0.tar.gz (http://ftp.gnu.org/gnu/ncurses/)
Save the downloaded ncurses-6.0.tar.gz to the tools/board/gdb/ directory of the osdrv.

e:util-linux-2.31.tar.gz (https://www.kernel.org/pub/linux/utils/util-linux/v2.31)
Save the downloaded util-linux-2.31.tar.gz to the tools/pc/cramfs_tool/ directory of the osdrv.

f:xz-5.2.2.tar.bz2 (https://tukaani.org/xz/old.html)
Save the downloaded xz-5.2.2.tar.bz2 file to the tools/pc/squashfs4.3/ directory of the osdrv.

g:e2fsprogs-1.42.13.tar.gz (https://sourceforge.net/projects/e2fsprogs/files/e2fsprogs/v1.42.13/)
Save the downloaded e2fsprogs-1.42.13.tar.gz file to the tools/board/e2fsprogs/ directory of the osdrv.

h: lzo-2.09.tar.gz (http://www.oberhumer.com/opensource/lzo/download/)
Save the downloaded lzo-2.09.tar.gz to the tools/pc/jffs2_tool/ directory of the osdrv.

i: eudev-3.2.7.tar.gz (https://dev.gentoo.org/~blueness/eudev/eudev-3.2.7.tar.gz)
Save the downloaded eudev-3.2.7.tar.gz file to the tools/board/eudev-3.2.7 directory of the osdrv.

j: libuuid-1.0.3.tar.gz (https://sourceforge.net/projects/libuuid/)
Save the downloaded libuuid-1.0.3.tar.gz to the tools/board/mtd-utils/ directory of the osdrv.
...
The zlib tool is used on both the PC and board. Therefore, you need to save the source code package to the following path:
Save the downloaded zlib-1.2.11.tar.gz to the tools/board/mtd-utils/ directory of the osdrv.
Save the downloaded zlib-1.2.11.tar.gz to the tools/pc/zlib/ directory of the osdrv.
Save the downloaded zlib-1.2.11.tar.gz to the tools/pc/squashfs4.3/ directory of the osdrv.

l: mtd-utils-2.0.2.tar.bz2 (https://src.fedoraproject.org/repo/pkgs/mtd-utils/mtd-utils-2.0.2.tar.bz2/)
The mtd-utils is used on both the PC and board. Therefore, you need to save the source code package to the following path:
Save the downloaded mtd-utils-2.0.2.tar.bz2 to the tools/board/mtd-utils/ directory of the osdrv.
Save the downloaded mtd-utils-2.0.2.tar.bz2 to the tools/pc/jffs2_tool/ directory of the osdrv.

m: gzip-1.8.tar.gz (http://ftp.gnu.org/gnu/gzip/gzip-1.8.tar.gz)
Save the downloaded gzip-1.8.tar.gz to the tools/pc/hi_gzip/ directory of the osdrv.

n: squashfs4.3.tar.gz (http://sourceforge.net/projects/squashfs/files/squashfs/squashfs4.3/squashfs4.3.tar.gz/download)
Save the downloaded squashfs4.3.tar.gz to the tools/pc/squashfs4.3/ directory of the osdrv.

o: extras-refs_tags_android-4.1.1_r1-ext4_utils.tar.gz (https://android.googlesource.com/platform/system/extras/+/refs/tags/android-4.1.1_r1/ext4_utils/)
Save the downloaded extras-refs_tags_android-4.1.1_r1-ext4_utils.tar.gz to the tools/pc/ext4_utils directory of the osdrv.
...
Download the V4.9.37 kernel from the Linux open source community.
	...
	The hi3516dv200 and hi3516ev300 support the arm-himix200-linux toolchain.
