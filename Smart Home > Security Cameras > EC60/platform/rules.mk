...
BOARD:=$(call qstrip,$(CONFIG_BOARD_NAME))
TARGET_OPTIMIZATION:=$(call qstrip,$(CONFIG_TARGET_OPTIMIZATION))
LINK_OPTIMIZATION:=$(call qstrip,$(CONFIG_LINK_OPTIMIZATION))
...
TARGET_LDFLAGS:=$(LINK_OPTIMIZATION) -L$(STAGING_DIR)/usr/lib -L$(STAGING_DIR)/lib -Wl,-rpath-link,$(STAGING_DIR)/usr/lib
TARGET_LDFLAGS_FOR_LD:=$(LINK_OPTIMIZATION) -L$(STAGING_DIR)/usr/lib -L$(STAGING_DIR)/lib -rpath-link $(STAGING_DIR)/usr/lib
...
ifeq ($(CONFIG_NEED_EXTERNAL_TARGET_FLAGS),y)
  ifneq ($(CONFIG_EXTERNAL_TARGET_FLAGS_STAGING_PATH),"")
    ifneq ($(CONFIG_EXTERNAL_TARGET_FLAGS_TOOLCHAIN_PATH),"")
      TARGET_CPPFLAGS:=-I$(TOPDIR)/$(subst ",,$(CONFIG_EXTERNAL_TARGET_FLAGS_STAGING_PATH))/usr/include -I$(TOPDIR)/$(subst ",,$(CONFIG_EXTERNAL_TARGET_FLAGS_STAGING_PATH))/include -I$(TOPDIR)/$(subst ",,$(CONFIG_EXTERNAL_TARGET_FLAGS_TOOLCHAIN_PATH))/usr/include -I$(TOPDIR)/$(subst ",,$(CONFIG_EXTERNAL_TARGET_FLAGS_TOOLCHAIN_PATH))/include
      TARGET_LDFLAGS:=-L$(TOPDIR)/$(subst ",,$(CONFIG_EXTERNAL_TARGET_FLAGS_STAGING_PATH))/usr/lib -L$(TOPDIR)/$(subst ",,$(CONFIG_EXTERNAL_TARGET_FLAGS_STAGING_PATH))/lib -L$(TOPDIR)/$(subst ",,$(CONFIG_EXTERNAL_TARGET_FLAGS_TOOLCHAIN_PATH))/usr/lib -L$(TOPDIR)/$(subst ",,$(CONFIG_EXTERNAL_TARGET_FLAGS_TOOLCHAIN_PATH))/lib
    endif
  endif
endif
