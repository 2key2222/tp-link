...
define autocmd_target
  $(strip $(call autocmd, $(PKG_BUILD_DIR), $(PKG_AUTO_CMD)))
endef
...
ifneq ($(filter autocmd,$(PKG_FIXUP)),)
  ifeq ($(filter autocmd,$(Hooks/Configure/Pre)),)
    Hooks/Configure/Pre += autocmd_target
  endif
endif
