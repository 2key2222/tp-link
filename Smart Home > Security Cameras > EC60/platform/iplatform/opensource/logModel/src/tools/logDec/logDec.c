 ...
 *					cited here : http://www.iteye.com/topic/478024
 *
...
{
	if(argc < 2){
		printf("arg less than 2,format:[./logDec srcPath] ,use as:./logDec log.txt\n");
		return -1;	
	}
	
	char *pDecPath = argv[1];
	if( DES_Decrypt(pDecPath, LOG_ENCRYPTION_KEY, "src.log") )
	{
