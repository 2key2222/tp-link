...
#define __KERNEL_HEADERS__ "/home/sying/SDK_CPU_UNIFIED/build/script/arm-himix100-linux/arm_himix100_build_dir/install/target/usr/include"
...
#define __RUNTIME_PREFIX__ "/usr/../"
#define __DEVEL_PREFIX__ "/usr"
#define __MULTILIB_DIR__ "lib/a73_a53_hard_neon-vfpv4"
...
#define __UCLIBC_EXTRA_CFLAGS__ "-mcpu=cortex-a17.cortex-a7 -mfloat-abi=hard -mfpu=neon-vfpv4 -g -O2 -fstack-check"
#undef __DODEBUG__
