...
tplink_board_detect() {
	...
	"084100"*)
		...
		;;
############################ zhoushengyong  Add WVR300 profile 
	"030000"*)
		model="TP-LINK TL-WVR300 V1/2/3"
		;;
############################ zhoushengyong  Add WVR300 profile 
	...
	"431000"*)
		...
		;;		                
	"450000"*)
		model="TP-Link TL-WVR450G"
		;;
	"130000"*)
		model="TP-Link TL-WVR1300G"
		;;
	*)
		hwver=""
		;;
...
ar71xx_board_detect() {
	...
	*"TL-WR841N/ND v8")
		...
		;;
############################ zhoushengyong  Add WVR300 profile 
######## TP-LINK TL-WVR300  from /proc/cpuinfo
	*"TP-LINK TL-WVR300 V1/2/3")
		name="tl-wvr300"
		;;
############################ zhoushengyong  Add WVR300 profile 
