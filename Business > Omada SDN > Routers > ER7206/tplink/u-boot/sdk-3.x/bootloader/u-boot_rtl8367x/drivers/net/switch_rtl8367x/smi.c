                     ...
                     rtk_uint32 data)
{
    ...
    ret = cvmx_mdio_write(SMI_BUS_ID, phy_id, register_id, data);

    cvmx_wait_usec(100);


    pr_debug("cvmx_mdio_read phy_id 0x%08x register_id 0x%08x value 0x%08x | ret %d\n", phy_id, register_id, data, ret);
}
                     ...
                     rtk_uint32 *pdata)
{
    ...
    val = cvmx_mdio_read(SMI_BUS_ID, phy_id, register_id);

    cvmx_wait_usec(100);

    pr_debug("cvmx_mdio_read phy_id 0x%08x register_id 0x%08x value 0x%08x\n", phy_id, register_id, val);
