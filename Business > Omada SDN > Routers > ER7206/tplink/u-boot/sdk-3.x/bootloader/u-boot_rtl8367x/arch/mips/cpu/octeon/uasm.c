...
enum opcode {
	...
	insn_ld, insn_ll, insn_lld, insn_lui, insn_lw, insn_mfc0, insn_mtc0,
	insn_mul, insn_or, insn_ori, insn_pref, insn_rfe, insn_sc, insn_scd,
	...
	insn_syscall, insn_wait, insn_zcb, insn_zcbt
};
...
static struct insn insn_table[] __uasminitdata = {
	...
	{ insn_wait, M(cop0_op, cop_op, 0, 0, 0, wait_op), 0 },
...
{
	return (((((val + 0x8000L) >> 16) & 0xffff) ^ 0x8000) - 0x8000) & 0xffff;
}
