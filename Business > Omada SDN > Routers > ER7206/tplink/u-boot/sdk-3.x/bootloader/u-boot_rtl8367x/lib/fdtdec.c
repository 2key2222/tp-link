...
static const char * const compat_names[COMPAT_COUNT] = {
	...
	COMPAT(CAVIUM_OCTEON_I2C, "cavium,octeon-3860-twsi"),
	COMPAT(CAVIUM_OCTEON_SMI, "cavium,octeon-3860-mdio"),
	COMPAT(CAVIUM_OCTEON_UART, "cavium,octeon-3860-uart"),
	COMPAT(CAVIUM_OCTEON_GPIO, "cavium,octeon-3860-gpio"),
	COMPAT(CAVIUM_OCTEON_MIX, "cavium,octeon-5750-mix"),
	COMPAT(CAVIUM_OCTEON_PIP, "cavium-octeon-3860-pip"),
};
