...
int checkboard(void)
{
...
#if 0
	/* DLM0: SGMII/SGMII */
	octeon_configure_qlm(0, 2500, CVMX_QLM_MODE_SGMII_SGMII, 0, 0, clksel_to_use, 0);
#endif
#if 1
	/* DLM0: QSGMII/QSGMII */
	octeon_configure_qlm(0, 2500, CVMX_QLM_MODE_QSGMII_QSGMII, 0, 0, clksel_to_use, iclk_to_use);
#endif

#if 0
	/* DLM0: RXAUI/DISABLED */
	/* Use external reference clock 156 MHz for RXAUI interface */
	octeon_configure_qlm(0, 3125, CVMX_QLM_MODE_RXAUI, 0, 0, clksel_to_use, 1);
#endif
	...
	/* PCIe0/PCIe1 2x2 */
	if (host_mode) {
		octeon_configure_qlm(1, 5000, CVMX_QLM_MODE_PCIE_1X2, 1, 1, 0, 0);
	}
	octeon_configure_qlm(2, 5000, CVMX_QLM_MODE_PCIE_1X2, 1, 1, 0, 0);
	/* NOTE: Disable SATA in this mode */
#endif
#if 0
	/* PCIe0/PCIe1/PCIe2 3x1 */
	if (host_mode)
		octeon_configure_qlm(1, 5000, CVMX_QLM_MODE_PCIE_1X1, 1, 1, 0, 0);
	octeon_configure_qlm(2, 5000, CVMX_QLM_MODE_PCIE_2X1, 1, 1, 0, 0);
	/* NOTE: Disable SATA in this mode */
#endif
#if 1
	/* PCIe0/PCIe1 1x2 */
