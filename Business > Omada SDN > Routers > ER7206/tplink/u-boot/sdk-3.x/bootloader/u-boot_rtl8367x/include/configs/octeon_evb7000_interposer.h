 ...
 * Octeon EVB7000-Interposer board.
 */
...
/*
 * Define for tweaks that need to be made for EVB7000 bringup.
 * These changes need to be reviewed for proper handling in some
 * other way.
 */
#define EVB7000_BRINGUP_HACK
...
/* CONFIG_OCTEON_EVB7000_INTERPOSER set by Makefile in include/config.h */

/* Default DDR clock if tuple doesn't exist in EEPROM */
#define EVB7000_INTERPOSER_DEF_DRAM_FREQ	400
...
#define CONFIG_SYS_I2C_EEPROM_ADDR	OCTEON_EVB7000_INTERPOSER_BOARD_EEPROM_TWSI_ADDR
...
/* The CN70XX has two TWSI buses and the EVB7000 Interposer board uses both
 * of them
 */
...
#include "octeon_evb7000_interposer_shared.h"
