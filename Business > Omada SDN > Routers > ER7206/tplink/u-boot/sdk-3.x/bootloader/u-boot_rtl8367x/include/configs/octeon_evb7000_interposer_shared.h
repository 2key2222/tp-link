#ifndef __OCTEON_EVB7000_INTERPOSER_SHARED_H__
#define __OCTEON_EVB7000_INTERPOSER_SHARED_H__

#define OCTEON_EVB7000_INTERPOSER_SPD_VALUES \
...
#define OCTEON_EVB7000_INTERPOSER_DRAM_SOCKET_CONFIGURATION0 \
	{{0x0, 0x0}, {octeon_evb7000_interposer_spd_values, NULL}}

#define OCTEON_EVB7000_INTERPOSER_BOARD_EEPROM_TWSI_ADDR	(0x54)
 ...
 *
 */
#define OCTEON_EVB7000_INTERPOSER_MODEREG_PARAMS1_1RANK_1SLOT	\
{							\
	.cn63xx = {					\
		.pasr_00	= 0,			\
		.asr_00		= 0,			\
...
#define OCTEON_EVB7000_INTERPOSER_MODEREG_PARAMS1_2RANK_1SLOT	\
{							\
	.cn63xx = {					\
		.pasr_00	= 0,			\
		.asr_00		= 0,			\
...
#define OCTEON_EVB7000_INTERPOSER_DRAM_ODT_1RANK_CONFIGURATION \
	/* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1            RODT_CTL    RODT_MASK    reserved */	\
	/* =====   ======== ============== ========================================== ========= ============== ======== */	\
	/*   1 */ {   0,    0x00000001ULL, OCTEON_EVB7000_INTERPOSER_MODEREG_PARAMS1_1RANK_1SLOT,    3,     0x00000000ULL,  0  }	\

#define OCTEON_EVB7000_INTERPOSER_DRAM_ODT_2RANK_CONFIGURATION \
	/* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1            RODT_CTL    RODT_MASK    reserved */	\
	/* =====   ======== ============== ========================================== ========= ============== ======== */	\
	/*   1 */ {   0,    0x00000101ULL, OCTEON_EVB7000_INTERPOSER_MODEREG_PARAMS1_2RANK_1SLOT,    3,     0x00000000ULL,    0  }    \
...
#define OCTEON_EVB7000_INTERPOSER_DDR_CONFIGURATION {			\
	/* Interface 0 */						\
	.custom_lmc_config = {						\
		.min_rtt_nom_idx	= 1,				\
		.max_rtt_nom_idx	= 5,				\
        ...
        .dimm_config_table = {						\
		OCTEON_EVB7000_INTERPOSER_DRAM_SOCKET_CONFIGURATION0,	\
	...
	.odt_1rank_config = {                        			\
		OCTEON_EVB7000_INTERPOSER_DRAM_ODT_1RANK_CONFIGURATION,	\
	},								\
	.odt_2rank_config = {						\
		OCTEON_EVB7000_INTERPOSER_DRAM_ODT_2RANK_CONFIGURATION,	\
	},								\
}
#endif   /* __OCTEON_EVB7000_INTERPOSER_SHARED_H__ */
