...
#define OCTEON_CLARK_DRAM_ODT_1RANK_CONFIGURATION \
	...
	/* =====   ======== ============== ========================================== ========= ============== ======== */	\
	/*   1 */ {   0,    0x00000001ULL, OCTEON_CLARK_MODEREG_PARAMS1_1RANK_1SLOT,    3,     0x00000000ULL,  0  }	\

#define OCTEON_CLARK_DRAM_ODT_2RANK_CONFIGURATION \
	/* DIMMS   reserved  WODT_MASK                LMCX_MODEREG_PARAMS1            RODT_CTL    RODT_MASK    reserved */	\
	/* =====   ======== ============== ========================================== ========= ============== ======== */	\
	/*   1 */ {   0,    0x00000101ULL, OCTEON_CLARK_MODEREG_PARAMS1_2RANK_1SLOT,    3,     0x00000000ULL,    0  }    \
