...
enum fdt_compat_id {
	...
	COMPAT_CAVIUM_OCTEON_I2C,       /* Cavium OCTEON 64-bit MIPS processors TWSI*/
	COMPAT_CAVIUM_OCTEON_SMI,	/* Cavium OCTEON MDIO bus */
	COMPAT_CAVIUM_OCTEON_UART,	/* Cavium OCTEON UART */
	COMPAT_CAVIUM_OCTEON_GPIO,	/* Cavium OCTEON GPIO */
	COMPAT_CAVIUM_OCTEON_MIX,	/* Cavium OCTEON management port */
	COMPAT_CAVIUM_OCTEON_PIP,	/* Cavium OCTEON packet input processor */
	COMPAT_COUNT,
};
