...
{
       0,    85,    85,    94,    97,   104,   108,   116,   123,   127,
     131,   146,   154,   157,   164,   168,   172,   180,   184,   188,
     192,   196,   214,   224,   232,   235,   239,   247,   250,   254,
     259,   266,   274,   277,   281,   289,   292,   296,   304,   308
};
#endif
...
/* Line 1455 of yacc.c  */
#line 132 "dtc-parser.y"
    {
			struct node *target;

			target = get_node_by_label((yyvsp[(1) - (3)].node), (yyvsp[(2) - (3)].labelref));
			if (target)
