...
{
	if((strcmp(var_entry->key, "bootdelay") == 0)
		||(strcmp(var_entry->key, "baudrate") == 0)
		||(strcmp(var_entry->key, "autoload") == 0)
		||(strcmp(var_entry->key, "bootli") == 0)
		||(strcmp(var_entry->key, "bootcmd") == 0)
		||(strcmp(var_entry->key, "diphy") == 0)
		||(strcmp(var_entry->key, "enphy") == 0)
		||(strcmp(var_entry->key, "resetenv") == 0)
		||(strcmp(var_entry->key, "loadaddr") == 0))
	{
		return;
	}
