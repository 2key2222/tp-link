...
#define LOWER_RANGE_SIZE (CONFIG_SDRAM_TOTAL_SIZE / 2)
#define UPPER_RANGE_SIZE (CONFIG_SDRAM_TOTAL_SIZE / 2)

dramMemRange memoryMap[MapSize] =
             {{"LOWER RAM",  
                     CONFIG_SDRAM_LOWER_RANGE_BASE, 
                     LOWER_RANGE_SIZE},
              {"UPPER RAM",  
                     CONFIG_SDRAM_UPPER_RANGE_BASE, 
                     UPPER_RANGE_SIZE},
              {NULL, 0, 0},
              {NULL, 0, 0}};
...
{    
    return CONFIG_SDRAM_DATABUS_WIDTH;
}

int dt_dramAddrBusWidth (void)
{
    int size_mem = CONFIG_SDRAM_TOTAL_SIZE, width = 0;
