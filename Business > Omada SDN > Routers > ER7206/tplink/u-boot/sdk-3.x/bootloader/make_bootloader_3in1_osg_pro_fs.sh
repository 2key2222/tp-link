...
echo "make ${MODEL}_fs bootloader : ..."
...
cat bootloader_${MODEL}_stage3.bin bootloader_${MODEL}_stage3_env.bin > bootloader_3in1_${MODEL}_fs.bin

echo "make ${MODEL}_fs bootloader : DONE!"
