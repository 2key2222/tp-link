...
The host operating system used for development is RHEL 5.x on i386/x86_64
architecture and RHEL 6.x on i386/x86_64 architecture. Other configurations
may work, but have not been tested. Running simulations of multiple cores 
requires a lot of RAM: a minimum of 512 MBytes is required, and 1 GByte+ is
recommended.
