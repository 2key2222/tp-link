...
$.su.Widget("textbox", {
	...
	create: function(defaults, options){
		...
		container.delegate("input.text-text", "click", function(e){
			...
			if(e.keyCode == 17 && $(this).attr("overflow") == "true"){
			...
			if(lastkeyCode == 17 && (e.keyCode == 67 || e.keyCode == 86)){ //ctrl+c ctrl+v
				if($(this).val().length < $(this).attr("maxlength")){
					$(this).attr("overflow", false);
				}
				lastkeyCode = e.keyCode;
			...
			lastkeyCode = e.keyCode;
			if( e.keyCode == 9 || e.keyCode == 13 || e.keyCode == 16 || e.keyCode == 18 || e.keyCode == 20
				|| e.keyCode == 37 || e.keyCode == 38 || e.keyCode == 39 || e.keyCode == 40){
				// 9:Tab 13:enter 16:Shift 18:Alt 20:Caps Lock
				// 37:←  38:↑  39:→  40:↓
				if($(this).val().length < $(this).attr("maxlength")){
					$(this).attr("overflow", false);
				}
