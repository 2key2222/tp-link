...
BIN_DIR:=$(if $(call qstrip,$(CONFIG_BINARY_FOLDER)),$(call qstrip,$(CONFIG_BINARY_FOLDER)),$(TOPDIR)/bin/$(BOARD)-$(PRODUCT))
INCLUDE_DIR:=$(TOPDIR)/include
TPLINK_DIR:=$(TOPDIR)/tplink
TPLINK_CATEGORY:=@@@@@ TPLINK Proprietary
...
BUILD_DIR:=$(BUILD_DIR_BASE)/$(TARGET_DIR_NAME)-$(PRODUCT)
STAGING_DIR:=$(TOPDIR)/staging_dir/$(TARGET_DIR_NAME)-$(PRODUCT)
...
TARGET_CFLAGS:=$(TARGET_OPTIMIZATION)$(if $(CONFIG_DEBUG), -g3) $(EXTRA_OPTIMIZATION) -Wl,--rpath=$(STAGING_DIR)/usr/lib
