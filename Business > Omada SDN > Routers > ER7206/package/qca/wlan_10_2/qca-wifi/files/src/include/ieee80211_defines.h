...
#define NODE_STAT_INCLUDE_RATE 1
#if NODE_STAT_INCLUDE_RATE
#define NODE_STAT_SNAPS 8
    u_int32_t   ns_tx_mintime;
    u_int32_t   ns_tx_realtime;

    u_int32_t   ns_stat_index;
    u_int64_t   ns_stat_tx_bytes[NODE_STAT_SNAPS];
    u_int64_t	ns_stat_rx_bytes[NODE_STAT_SNAPS];
    u_int32_t   ns_stat_tx_mintime[NODE_STAT_SNAPS];
    u_int32_t   ns_stat_tx_realtime[NODE_STAT_SNAPS];
#endif
};
