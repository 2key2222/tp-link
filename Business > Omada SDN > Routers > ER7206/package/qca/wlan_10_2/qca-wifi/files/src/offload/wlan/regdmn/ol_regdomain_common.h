...
static const COUNTRY_CODE_TO_ENUM_RD ahCmnAllCountries[] = {
    ...
    /* Changed by chenxuan. Use Band4 only. */
#if TP_FEATURE_BAND1_AND_BAND4
	{CTRY_CHINA,       APL4_WORLD,    "CN", "CHINA",          YES, YES, YES, YES, YES, YES, YES, YES, 7000 },
#else
...
/*    {CTRY_JAPAN56,     MKK5_FCCA,     "JP", "JAPAN56",        YES,  NO,  NO, YES, YES, YES, YES, YES, 7000 },*/
    ...
    {CTRY_MACAU,       APL1_WORLD,    "MO", "MACAU SAR",      YES, YES, YES, YES, YES, YES, YES, YES, 7000 },
...
#if TP_FEATURE_BAND1_AND_BAND4
	/* change the default powerdfs to 40db for HW txpower */
	{ 5180, 5240, 40, 0, 20, 20, NO_DFS, PSCAN_FCC | PSCAN_ETSI, 1 },		/* F5_5180_5240 */
#else
...
#if TP_FEATURE_BAND1_AND_BAND4
	/* change the default powerdfs to 40db for HW txpower */
    { 5745, 5825, 40, 0, 20, 20, NO_DFS, NO_PSCAN, 0 },				/* F9_5745_5825 */
#else
...
#if TP_FEATURE_BAND1_AND_BAND4
	/* unify power dfs(40dbm) with 5G */
	{ 2412, 2472, 40, 0, 20, 5, NO_DFS, PSCAN_MKKA, 0},	/* F4_2412_2472 */
#else
...
#if TP_FEATURE_BAND1_AND_BAND4
	/* unify power dfs(40dbm) with 5G */
	{ 2412, 2472, 40, 0, 20, 5,  NO_DFS, PSCAN_MKKA_G | PSCAN_MKKA2 | PSCAN_MKKA | PSCAN_EXT_CHAN, 0},	/* G4_2412_2472 */
#else
