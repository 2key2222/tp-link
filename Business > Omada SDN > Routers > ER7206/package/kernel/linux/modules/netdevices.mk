...
define KernelPackage/switch-rtl8367b
  SUBMENU:=$(NETWORK_DEVICES_MENU)
  TITLE:=Realtek RTL8367b switch support
  DEPENDS:=+kmod-switch-rtl8366-smi
...
define KernelPackage/switch-rtl8367b/description
 Realtek RTL8367B switch support
endef
...
define KernelPackage/switch-rtl8367s
  ...
  FILES:=$(LINUX_DIR)/drivers/net/phy/rtl8367s/rtl8367s_tp.ko
  AUTOLOAD:=$(call AutoLoad,43,rtl8367s_tp)
endef
