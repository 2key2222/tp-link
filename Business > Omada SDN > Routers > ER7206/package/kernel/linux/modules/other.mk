...
define KernelPackage/mtd-oops
  SUBMENU:=$(OTHER_MENU)
  TITLE:=Panic oops saver support
  KCONFIG:=CONFIG_MTD_OOPS
  FILES:= \
	$(LINUX_DIR)/drivers/mtd/mtdoops.ko
endef

define KernelPackage/mtd-oops/description
 Kernel module for Panic Oops
endef

$(eval $(call KernelPackage,mtd-oops))

define KernelPackage/mtd-ram
  SUBMENU:=$(OTHER_MENU)
  TITLE:=RAM MTD device support
  KCONFIG:=CONFIG_MTD_MTDRAM \
	CONFIG_MTDRAM_TOTAL_SIZE=10240 \
	CONFIG_MTDRAM_ERASE_SIZE=64
  FILES:= \
	$(LINUX_DIR)/drivers/mtd/devices/mtdram.ko
endef

define KernelPackage/mtd-ram/description
 Kernel module for RAM MTD device
endef

$(eval $(call KernelPackage,mtd-ram))
