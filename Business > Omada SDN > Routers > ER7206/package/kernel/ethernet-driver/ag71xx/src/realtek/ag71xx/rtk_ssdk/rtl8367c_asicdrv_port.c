 ...
 *
 * $Revision: 65073 $
 * $Date: 2016-01-14 11:15:53 +0800 (é€±å››, 14 ä¸€æœˆ 2016) $
 *
...
ret_t rtl8367c_setAsicPortExtMode(rtk_uint32 id, rtk_uint32 mode)
{
    ...
    else
    {
        ...
        {
/*!<
    WVR458G 2.0 Ê¹ÓÃÁËLEDÓ³Éä£¬ÐèÒª³õÊ¼»¯ÏÂÃæÈý¸ö¼Ä´æÆ÷µÄÖµ
    ×¢ÊÍµô£¬±ÜÃâ¸üÐÂPORT9 ËÙÂÊÊ±£¬ÐÞ¸ÄLED¼Ä´æÆ÷
    see rtk_board_init_wvr458gv2()  led init part
*/
#ifndef CONFIG_RTL8370MB
...
ret_t rtl8367c_getAsicPortExtMode(rtk_uint32 id, rtk_uint32 *pMode)
{
    ...
    else if (1 == type)
    {
        if (1 == id)
        {
            if ((retVal = rtl8367c_getAsicRegBit(0x1d92, 14, &regData))!=RT_ERR_OK)
                return retVal;
...
{
    rtk_uint32 retVal, regValue, state, i;
