 ...
 *
 * $Revision: 63929 $
 * $Date: 2015-12-08 12:50:55 +0800 (週二, 08 十二月 2015) $
 *
...
/*
@func ret_t | rtl8367c_setAsicLedOutputEnable_set | Set LED output enable
 ...
 */
ret_t rtl8367c_setAsicLedOutputEnable_set(rtk_uint32 enabled)
{
    ret_t retVal;
    rtk_uint32 regdata;
...
@comm
    The API can get LED serial mode setup and get signal active high/low.
 */
ret_t rtl8367c_getAsicLedOutputEnable_get(rtk_uint32 *ptr_enabled)
{
    ret_t retVal;
    rtk_uint32 regdata;
