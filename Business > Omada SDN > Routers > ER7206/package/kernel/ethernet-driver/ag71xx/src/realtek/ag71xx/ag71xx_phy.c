...
extern void (*wan_status_handle)(int);
...
static void ag71xx_phy_link_adjust(struct net_device *dev)
{
	...
	unsigned long flags;
	int status_change = 0;
#if (defined(CONFIG_ATH79_SOC_QCA9531) || defined(CONFIG_ATH79_SOC_QCA9561) || defined(CONFIG_ATH79_SOC_QCA9563))
...
#if 0
		/* handle wan status change */
		if (wan_status_handle) {
			(*wan_status_handle)(phydev->link);
		}
#endif
	}
