...
extern rtl8367s_change_vlan_phylink(struct phy_device *phydev, int vid, bool linkup);
#endif
...
static int ag71xx_change_vlan_phylink(struct net_device* dev, int vid, bool linkup)
{
        ...
        return (ag->phy_dev) ? rtl8367s_change_vlan_phylink(ag->phy_dev, vid, linkup) : 0;
}
#else
static int ag71xx_change_vlan_phylink(struct net_device* dev, int vid, bool linkup)
{
...
static int __init ag71xx_module_init(void)
{
        ...
        ath79_eth0_data.duplex = DUPLEX_FULL;
/*!<
    WVR458G 2.0的RTL8370MB的地址为0，RTL8211F的地址为5
*/
#ifdef CONFIG_RTL8370MB
        ath79_eth0_data.phy_mask = BIT(0)|BIT(5);
#else
        ath79_eth0_data.phy_mask = BIT(29);
#endif
