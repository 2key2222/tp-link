...
extern void ath79_ddr_wb_flush(unsigned int reg);
...
void __init ath79_init_mdio_pdata(unsigned int id, u32 phy_mask)
{
	struct platform_device *mdio_dev;
	struct ag71xx_mdio_platform_data *mdio_data;
	unsigned int max_id;

#if (defined(CONFIG_ATH79_SOC_AR9341) ||defined(CONFIG_ATH79_SOC_AR9342) || \
	defined(CONFIG_ATH79_SOC_AR9344) ||defined(CONFIG_ATH79_SOC_QCA9558))
		max_id = 1;
#else
		max_id = 0;
#endif
...
#if (defined(CONFIG_ATH79_SOC_AR7241) ||defined(CONFIG_ATH79_SOC_AR9330) || \
	    defined(CONFIG_ATH79_SOC_AR9331) ||defined(CONFIG_ATH79_SOC_QCA9533) || \
	    defined(CONFIG_ATH79_SOC_QCA9531) || defined(CONFIG_ATH79_SOC_QCA9561) || \
	    defined(CONFIG_ATH79_SOC_QCA9563))
	mdio_dev = &ath79_mdio1_device;
	mdio_data = &ath79_mdio1_data;
	
#elif (defined(CONFIG_ATH79_SOC_AR9341) ||defined(CONFIG_ATH79_SOC_AR9342) || \
	    defined(CONFIG_ATH79_SOC_AR9344) ||defined(CONFIG_ATH79_SOC_QCA9558))
	if (id == 0) {
...
#elif defined(CONFIG_ATH79_SOC_AR7242)
...
#if defined(CONFIG_ATH79_SOC_AR7240)
	mdio_data->is_ar7240 = 1;
	mdio_data->builtin_switch = 1;
#elif defined(CONFIG_ATH79_SOC_AR7241)
	mdio_data->builtin_switch = 1;
#elif defined(CONFIG_ATH79_SOC_AR9330)
	mdio_data->is_ar9330 = 1;
	mdio_data->builtin_switch = 1;
#elif (defined(CONFIG_ATH79_SOC_AR9331) || defined(CONFIG_ATH79_SOC_QCA9531) || \
	 defined(CONFIG_ATH79_SOC_QCA9561) || defined(CONFIG_ATH79_SOC_QCA9563))
	mdio_data->builtin_switch = 1;
#elif (defined(CONFIG_ATH79_SOC_AR9341) || defined(CONFIG_ATH79_SOC_AR9342) || \
	defined(CONFIG_ATH79_SOC_AR9344))
	if (id == 1) {
		mdio_data->builtin_switch = 1;
...
#elif defined(CONFIG_ATH79_SOC_QCA9533)
	mdio_data->builtin_switch = 1;
#elif defined(CONFIG_ATH79_SOC_QCA9558)
	mdio_data->is_ar934x = 1;
#else
	BUG();
#endif
...
#if (defined(CONFIG_ATH79_SOC_AR7130) || defined(CONFIG_ATH79_SOC_AR7141) || \
	defined(CONFIG_ATH79_SOC_AR7161))
	pll_10 = AR71XX_PLL_VAL_10;
	pll_100 = AR71XX_PLL_VAL_100;
	pll_1000 = AR71XX_PLL_VAL_1000;
#elif (defined(CONFIG_ATH79_SOC_AR7240) || defined(CONFIG_ATH79_SOC_AR7241))
...
#elif (defined(CONFIG_ATH79_SOC_AR9130) || defined(CONFIG_ATH79_SOC_AR9132))
	pll_10 = AR913X_PLL_VAL_10;
	pll_100 = AR913X_PLL_VAL_100;
	pll_1000 = AR913X_PLL_VAL_1000;
#elif (defined(CONFIG_ATH79_SOC_AR9330) || defined(CONFIG_ATH79_SOC_AR9331))
	pll_10 = AR933X_PLL_VAL_10;
	pll_100 = AR933X_PLL_VAL_100;
	pll_1000 = AR933X_PLL_VAL_1000;
#elif (defined(CONFIG_ATH79_SOC_AR9341) || defined(CONFIG_ATH79_SOC_AR9342) || \
	defined(CONFIG_ATH79_SOC_AR9344) || defined(CONFIG_ATH79_SOC_QCA9531) || \
	defined(CONFIG_ATH79_SOC_QCA9533) || defined(CONFIG_ATH79_SOC_QCA9558) || \
	defined(CONFIG_ATH79_SOC_QCA9561) || defined(CONFIG_ATH79_SOC_QCA9563))
					   ...
					   struct ag71xx_platform_data *pdata)
{
	...
	case 0:
#if (defined(CONFIG_ATH79_SOC_AR7130) || defined(CONFIG_ATH79_SOC_AR7141) || \
	defined(CONFIG_ATH79_SOC_AR7161) || defined(CONFIG_ATH79_SOC_AR9130) || \
	defined(CONFIG_ATH79_SOC_AR9132))
...
#elif (defined(CONFIG_ATH79_SOC_AR7240) || defined(CONFIG_ATH79_SOC_AR7241) || \
	defined(CONFIG_ATH79_SOC_AR9330) || defined(CONFIG_ATH79_SOC_AR9331) || \
	defined(CONFIG_ATH79_SOC_QCA9531) || defined(CONFIG_ATH79_SOC_QCA9533) || \
	defined(CONFIG_ATH79_SOC_QCA9561) || defined(CONFIG_ATH79_SOC_QCA9563))
		pdata->phy_if_mode = PHY_INTERFACE_MODE_MII;
#elif (defined(CONFIG_ATH79_SOC_AR7242) || defined(CONFIG_ATH79_SOC_AR9341) || \
	defined(CONFIG_ATH79_SOC_AR9342) || defined(CONFIG_ATH79_SOC_AR9344))	/* CONFIG_ATH79_SOC_AR7242 FIXME */
		switch (pdata->phy_if_mode) {
		case PHY_INTERFACE_MODE_MII:
		case PHY_INTERFACE_MODE_GMII:
		case PHY_INTERFACE_MODE_RGMII:
...
#elif (defined(CONFIG_ATH79_SOC_AR7240) || defined(CONFIG_ATH79_SOC_AR7241) || \
	defined(CONFIG_ATH79_SOC_AR9330) || defined(CONFIG_ATH79_SOC_AR9331) || \
	defined(CONFIG_ATH79_SOC_QCA9533))
		pdata->phy_if_mode = PHY_INTERFACE_MODE_GMII;
#elif (defined(CONFIG_ATH79_SOC_AR7242) || defined(CONFIG_ATH79_SOC_AR9341) || \
	defined(CONFIG_ATH79_SOC_AR9342) || defined(CONFIG_ATH79_SOC_AR9344) || \
	defined(CONFIG_ATH79_SOC_QCA9531) || defined(CONFIG_ATH79_SOC_QCA9561) || defined(CONFIG_ATH79_SOC_QCA9563))
		/* CONFIG_ATH79_SOC_AR7242 FIXME */
		switch (pdata->phy_if_mode) {
		case PHY_INTERFACE_MODE_MII:
		case PHY_INTERFACE_MODE_GMII:
			break;
...
void __init ath79_init_eth_pdata(unsigned int id)
{
...
#if defined(CONFIG_ATH79_SOC_AR7130)
	if (id == 0) {
...
#elif (defined(CONFIG_ATH79_SOC_AR7141) || defined(CONFIG_ATH79_SOC_AR7161))
	if (id == 0) {
		pdata->ddr_flush = ath79_ddr_flush_ge0;
		pdata->set_speed = ath79_set_speed_ge0;
	} else {
	...
	if (!pdata->fifo_cfg3)
		pdata->fifo_cfg3 = 0x01f00140;
#elif defined(CONFIG_ATH79_SOC_AR7240)
	if (id == 0) {
		pdata->reset_bit |= AR71XX_RESET_GE0_PHY;
		pdata->ddr_flush = ar724x_ddr_flush_ge0;
		pdata->set_speed = ath79_set_speed_dummy;
	...
	if (!pdata->fifo_cfg3)
		pdata->fifo_cfg3 = 0x01f00140;
#elif defined(CONFIG_ATH79_SOC_AR9130)
	if (id == 0) {
	...
	pdata->is_ar91xx = 1;
#elif defined(CONFIG_ATH79_SOC_AR9132)
	if (id == 0) {
		pdata->ddr_flush = ar91xx_ddr_flush_ge0;
		pdata->set_speed = ar91xx_set_speed_ge0;
	} else {
	...
	if (!pdata->fifo_cfg3)
		pdata->fifo_cfg3 = 0x01f00140;
#elif (defined(CONFIG_ATH79_SOC_QCA9531) || defined(CONFIG_ATH79_SOC_QCA9561) || CONFIG_ATH79_SOC_QCA9563)
	pdata->is_qca956x = 1;
	if (id == 1) {
		pdata->switch_data = &ath79_switch_data;
...
#elif (defined(CONFIG_ATH79_SOC_AR7241) || defined(CONFIG_ATH79_SOC_AR9330) || \
	defined(CONFIG_ATH79_SOC_AR9331) || defined(CONFIG_ATH79_SOC_QCA9531) || \
	defined(CONFIG_ATH79_SOC_QCA9533) || defined(CONFIG_ATH79_SOC_QCA9561) || \
	defined(CONFIG_ATH79_SOC_QCA9563))
		pdata->mii_bus_dev = &ath79_mdio1_device.dev;
#else
		pdata->mii_bus_dev = &ath79_mdio0_device.dev;
