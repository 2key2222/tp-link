...
#define MAX_INTERFACE_STR_LEN	(64)
...
struct session
{
    ...
    */
	...
	char interface[MAX_INTERFACE_STR_LEN];
    char zonex[MAX_INTERFACE_STR_LEN];
    /*
    **  Callback functions
    */
    void (*debug)(int,char *,...);
...
#define PHASE_DEAD		    50
#define PHASE_INITIALIZE	51
#define PHASE_RUNNING		52

#define BPA_UDP_PORT_LISTEN 5050
...
#define LOGGER_INFO_ID_BPA_SUCC_CONN          14241
#define LOGGER_INFO_ID_BPA_SUCC_DISCONN       14242
#define LOGGER_INFO_ID_BPA_FAIL_LOGOUT        14243
#define LOGGER_INFO_ID_BPA_FAIL_AUTH_SERVER   14244
#define LOGGER_INFO_ID_BPA_TIMEOUT            14245
#define LOGGER_INFO_ID_BPA_AUTH_SERVER        14246

#define LINE_BACKUP_LOGGER_REG(info_id, ...)       \
    logger_reg(LOGGER_MODULE_ID_BPALOGIN, info_id, ##__VA_ARGS__)
